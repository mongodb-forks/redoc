...
YargsParser.command('serve <spec>', 'start the server', yargs => {
    ...
    .command('build <spec>', 'build definition into zero-dependency HTML-file', builderForBuildCommand, handlerForBuildCommand)
    .command('bundle <spec>', 'bundle spec into zero-dependency HTML-file [deprecated]', builderForBuildCommand, handlerForBuildCommand, [
    res => {
