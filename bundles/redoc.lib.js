...
`,qc=re(jc)`
  margin: 0 5px 0 0;
`,Fc=re((t=>{const{name:r,opened:n,className:o,onClick:i,httpVerb:s,deprecated:a}=t;return e.createElement(Nc,{className:o,onClick:i||void 0},e.createElement(qc,{type:s},xt(s)),e.createElement(ji,{size:"1.5em",direction:n?"down":"right",float:"left"}),e.createElement(Mc,{deprecated:a},r),a?e.createElement(Ci,{type:"warning"}," ",L("deprecated")," "):null)}))`
  padding: 10px;
  border-radius: 2px;
  margin-bottom: 4px;
  line-height: 1.5em;
