...
`,Pc={0:G`
  ...
  `},Ic=re.label.attrs((e=>({role:"menuitem",className:Sc()("-depth"+e.depth,{active:e.active})})))`
  cursor: pointer;
  color: ${e=>e.active?jc(e.depth,e,"activeTextColor"):e.theme.sidebar.textColor};
  margin: 0;
  ...
  &:hover {
    color: ${e=>jc(e.depth,e,"activeTextColor")};
...
`,zc=re(Rc)`
  margin: 0 5px 0 0;
`,Mc=re((t=>{const{name:r,opened:n,className:o,onClick:i,httpVerb:s,deprecated:a}=t;return e.createElement(Lc,{className:o,onClick:i||void 0},e.createElement(zc,{type:s},xt(s)),e.createElement(ji,{size:"1.5em",direction:n?"down":"right",float:"left"}),e.createElement(Dc,{deprecated:a},r),a?e.createElement(Ci,{type:"warning"}," ",L("deprecated")," "):null)}))`
  padding: 10px;
  border-radius: 2px;
  margin-bottom: 4px;
  line-height: 1.5em;
...
`,Nc=re.div`
  ...
  margin-bottom: 5px;
  margin-top: 5px;
`;class qc extends e.PureComponent{constructor(){super(...arguments),this.selectElement=()=>{Ms.selectElement(this.child)}}render(){const{children:t}=this.props;return e.createElement("div",{ref:e=>this.child=e,onClick:this.selectElement,onFocus:this.selectElement,tabIndex:0,role:"button"},t)}}const Fc=re.div`
  cursor: pointer;
  position: relative;
  margin-bottom: 5px;
`,Bc=re.span`
...
`,Uc=re.span.attrs((e=>({className:`http-verb ${e.type}`})))`
...
`;class Jc extends e.Component{constructor(e){super(e),this.toggle=()=>{this.setState({expanded:!this.state.expanded})},this.state={expanded:!1}}render(){const{operation:t,inverted:r,hideHostname:n}=this.props,{expanded:o}=this.state;return e.createElement(de.Consumer,null,(i=>e.createElement(Fc,null,e.createElement(Qc,{onClick:this.toggle,expanded:o,inverted:r},e.createElement(Uc,{type:t.httpVerb,compact:this.props.compact},t.httpVerb),e.createElement(Bc,null,t.path),e.createElement(ji,{float:"right",color:r?"black":"white",size:"20px",direction:o?"up":"down",style:{marginRight:"-25px"}})),e.createElement(Wc,{expanded:o,"aria-hidden":!o},t.servers.map((r=>{const o=i.expandDefaultServerVariables?dt(r.url,r.variables):r.url,s=$(o);return e.createElement(Vc,{key:o},e.createElement(As,{source:r.description||"",compact:!0}),e.createElement(qc,null,e.createElement(Hc,null,e.createElement("span",null,n||i.hideHostname?"/"===s?"":s:o),t.path)))}))))))}}class Yc extends e.PureComponent{render(){const{place:t,parameters:r}=this.props;return r&&r.length?e.createElement("div",{key:t},e.createElement(bi,null,t," Parameters"),e.createElement(Mi,null,e.createElement("tbody",null,m(r,((t,r)=>e.createElement(Ya,{key:t.name,isLast:r,field:t,showExamples:!0})))))):null}}Object.defineProperty,Object.getOwnPropertyDescriptor;let Zc=class extends e.Component{constructor(){super(...arguments),this.switchMedia=({idx:e})=>{this.props.content&&void 0!==e&&this.props.content.activate(e)}}render(){const{content:t}=this.props;if(!t||!t.mediaTypes||!t.mediaTypes.length)return null;const r=t.activeMimeIdx,n=t.mediaTypes.map(((e,t)=>({value:e.name,idx:t}))),o=({children:t})=>this.props.withLabel?e.createElement(na,null,e.createElement(ra,null,"Content type"),t):t;return e.createElement(e.Fragment,null,e.createElement(o,null,this.props.renderDropdown({value:n[r].value,options:n,onChange:this.switchMedia,ariaLabel:"Content type"})),this.props.children(t.active))}};Zc=((e,t,r,n)=>{for(var o,i=t,s=e.length-1;s>=0;s--)(o=e[s])&&(i=o(i)||i);return i})([la.observer],Zc);var Gc=Object.defineProperty,Xc=Object.getOwnPropertySymbols,Kc=Object.prototype.hasOwnProperty,ep=Object.prototype.propertyIsEnumerable,tp=(e,t,r)=>t in e?Gc(e,t,{enumerable:!0,configurable:!0,writable:!0,value:r}):e[t]=r;const rp=["path","query","cookie","header"];class np extends e.PureComponent{orderParams(e){const t={};return e.forEach((e=>{var r,n,o;o=e,(r=t)[n=e.in]||(r[n]=[]),r[n].push(o)})),t}render(){const{body:t,parameters:r=[]}=this.props;if(void 0===t&&void 0===r)return null;const n=this.orderParams(r),o=r.length>0?rp:[],i=t&&t.content,s=t&&t.description;return e.createElement(e.Fragment,null,o.map((t=>e.createElement(Yc,{key:t,place:t,parameters:n[t]}))),i&&e.createElement(ip,{content:i,description:s}))}}function op(t){return e.createElement(bi,{key:"header"},"Request Body schema: ",e.createElement(xs,((e,t)=>{for(var r in t||(t={}))Kc.call(t,r)&&tp(e,r,t[r]);if(Xc)for(var r of Xc(t))ep.call(t,r)&&tp(e,r,t[r]);return e})({},t)))}function ip(t){const{content:r,description:n}=t,{isRequestType:o}=r;return e.createElement(Zc,{content:r,renderDropdown:op},(({schema:t})=>e.createElement(e.Fragment,null,void 0!==n&&e.createElement(As,{source:n}),"object"===(null==t?void 0:t.type)&&e.createElement(Pa,{constraints:(null==t?void 0:t.constraints)||[]}),e.createElement(Al,{skipReadOnly:o,skipWriteOnly:!o,key:"schema",schema:t}))))}const sp=e.memo((function({title:t,type:r,empty:n,code:o,opened:i,className:s,onClick:a}){return e.createElement("button",{className:s,onClick:!n&&a||void 0,"aria-expanded":i,disabled:n},!n&&e.createElement(ji,{size:"1.5em",color:r,direction:i?"down":"right",float:"left"}),e.createElement(pp,null,o," "),e.createElement(As,{compact:!0,inline:!0,source:t}))})),ap=re(sp)`
  display: block;
  border: 0;
  width: 100%;
  text-align: left;
...
`,lp=re.div`
  padding: 10px;
`,cp=re(bi.withComponent("caption"))`
  text-align: left;
  margin-top: 1em;
  caption-side: top;
`,pp=re.strong`
  vertical-align: top;
`;class up extends e.PureComponent{render(){const{headers:t}=this.props;return void 0===t||0===t.length?null:e.createElement(Mi,null,e.createElement(cp,null," Response Headers "),e.createElement("tbody",null,m(t,((t,r)=>e.createElement(Ya,{isLast:r,key:t.name,field:t,showExamples:!0})))))}}var dp=Object.defineProperty,hp=Object.getOwnPropertySymbols,mp=Object.prototype.hasOwnProperty,fp=Object.prototype.propertyIsEnumerable,gp=(e,t,r)=>t in e?dp(e,t,{enumerable:!0,configurable:!0,writable:!0,value:r}):e[t]=r;class yp extends e.PureComponent{constructor(){super(...arguments),this.renderDropdown=t=>e.createElement(bi,{key:"header"},"Response Schema: ",e.createElement(xs,((e,t)=>{for(var r in t||(t={}))mp.call(t,r)&&gp(e,r,t[r]);if(hp)for(var r of hp(t))fp.call(t,r)&&gp(e,r,t[r]);return e})({},t)))}render(){const{description:t,extensions:r,headers:n,content:o}=this.props.response;return e.createElement(e.Fragment,null,t&&e.createElement(As,{source:t}),e.createElement(ja,{extensions:r}),e.createElement(up,{headers:n}),e.createElement(Zc,{content:o,renderDropdown:this.renderDropdown},(({schema:t})=>e.createElement(e.Fragment,null,"object"===(null==t?void 0:t.type)&&e.createElement(Pa,{constraints:(null==t?void 0:t.constraints)||[]}),e.createElement(Al,{skipWriteOnly:!0,key:"schema",schema:t})))))}}const bp=(0,la.observer)((({response:t})=>{const{extensions:r,headers:n,type:o,summary:i,description:s,code:a,expanded:l,content:c}=t,p=e.useMemo((()=>void 0===c?[]:c.mediaTypes.filter((e=>void 0!==e.schema))),[c]),u=e.useMemo((()=>!(r&&0!==Object.keys(r).length||0!==n.length||0!==p.length||s)),[r,n,p,s]);return e.createElement("div",null,e.createElement(ap,{onClick:()=>t.toggle(),type:o,empty:u,title:i||"",code:a,opened:l}),l&&!u&&e.createElement(lp,null,e.createElement(yp,{response:t})))})),xp=re.h3`
  font-size: 1.3em;
  padding: 0.2em 0;
  margin: 3em 0 1.1em;
  color: ${({theme:e})=>e.colors.text.primary};
  font-weight: normal;
`;class vp extends e.PureComponent{render(){const{responses:t,isCallback:r}=this.props;return t&&0!==t.length?e.createElement("div",null,e.createElement(xp,null,L(r?"callbackResponses":"responses")),t.map((t=>e.createElement(bp,{key:t.code,response:t})))):null}}function wp(t){const{security:r,showSecuritySchemeType:n,expanded:o}=t,i=r.schemes.length>1;return 0===r.schemes.length?e.createElement(Bl,{expanded:o},"None"):e.createElement(Bl,{expanded:o},i&&"(",r.schemes.map((t=>e.createElement(Fl,{key:t.id},n&&`${tc[t.type]||t.type}: `,e.createElement("i",null,t.displayName),o&&t.scopes.length?[" (",t.scopes.map((t=>e.createElement(ql,{key:t},t))),") "]:null))),i&&") ")}const kp=({scopes:t})=>t.length?e.createElement("div",null,e.createElement("b",null,"Required scopes: "),t.map(((t,r)=>e.createElement(e.Fragment,{key:r},e.createElement("code",null,t)," ")))):null;function Op(t){const r=Oi(),n=null==r?void 0:r.options.showSecuritySchemeType,[o,i]=(0,e.useState)(!1),{securities:s}=t;if(!(null==s?void 0:s.length)||(null==r?void 0:r.options.hideSecuritySection))return null;const a=null==r?void 0:r.spec.securitySchemes.schemes.filter((({id:e})=>s.find((t=>t.schemes.find((t=>t.id===e))))));return e.createElement(e.Fragment,null,e.createElement(Vl,{expanded:o},e.createElement(Ql,{onClick:()=>i(!o)},e.createElement(Wl,null,"Authorizations:"),e.createElement(ji,{size:"1.3em",direction:o?"down":"right"})),e.createElement(Ul,{expanded:o},s.map(((t,r)=>e.createElement(wp,{key:r,expanded:o,showSecuritySchemeType:n,security:t}))))),o&&(null==a?void 0:a.length)&&a.map(((t,r)=>e.createElement(Jl,{key:r},e.createElement("h5",null,e.createElement(Ep,null)," ",tc[t.type]||t.type,": ",t.id),e.createElement(As,{source:t.description||""}),e.createElement(ec,{key:t.id,scheme:t,RequiredScopes:e.createElement(kp,{scopes:Sp(t.id,s)})})))))}const Ep=()=>e.createElement("svg",{xmlns:"http://www.w3.org/2000/svg",viewBox:"0 0 24 24",width:"11",height:"11"},e.createElement("path",{fill:"currentColor",d:"M18 10V6A6 6 0 0 0 6 6v4H3v14h18V10h-3zM8 6c0-2.206 1.794-4 4-4s4 1.794 4 4v4H8V6zm11 16H5V12h14v10z"}));function Sp(e,t){const r=[];let n=t.length;for(;n--;){const o=t[n];let i=o.schemes.length;for(;i--;){const t=o.schemes[i];t.id===e&&Array.isArray(t.scopes)&&r.push(...t.scopes)}}return Array.from(new Set(r))}Object.defineProperty,Object.getOwnPropertyDescriptor;let $p=class extends e.Component{render(){const{operation:t}=this.props,{description:r,externalDocs:n}=t,o=!(!r&&!n);return e.createElement(Nc,null,o&&e.createElement(Rp,null,void 0!==r&&e.createElement(As,{source:r}),n&&e.createElement(Ea,{externalDocs:n})),e.createElement(Jc,{operation:this.props.operation,inverted:!0,compact:!0}),e.createElement(ja,{extensions:t.extensions}),e.createElement(Op,{securities:t.security}),e.createElement(np,{parameters:t.parameters,body:t.requestBody}),e.createElement(vp,{responses:t.responses,isCallback:t.isCallback}))}};$p=((e,t,r,n)=>{for(var o,i=t,s=e.length-1;s>=0;s--)(o=e[s])&&(i=o(i)||i);return i})([la.observer],$p);const Rp=re.div`
  margin-bottom: ${({theme:e})=>3*e.spacing.unit}px;
`;Object.defineProperty,Object.getOwnPropertyDescriptor;let jp=class extends e.Component{constructor(){super(...arguments),this.toggle=()=>{this.props.callbackOperation.toggle()}}render(){const{name:t,expanded:r,httpVerb:n,deprecated:o}=this.props.callbackOperation;return e.createElement(e.Fragment,null,e.createElement(Mc,{onClick:this.toggle,name:t,opened:r,httpVerb:n,deprecated:o}),r&&e.createElement($p,{operation:this.props.callbackOperation}))}};jp=((e,t,r,n)=>{for(var o,i=t,s=e.length-1;s>=0;s--)(o=e[s])&&(i=o(i)||i);return i})([la.observer],jp);class Cp extends e.PureComponent{render(){const{callbacks:t}=this.props;return t&&0!==t.length?e.createElement("div",null,e.createElement(Ap,null," Callbacks "),t.map((t=>t.operations.map(((r,n)=>e.createElement(jp,{key:`${t.name}_${n}`,callbackOperation:r})))))):null}}const Ap=re.h3`
  font-size: 1.3em;
  padding: 0.2em 0;
  margin: 3em 0 1.1em;
  color: ${({theme:e})=>e.colors.text.primary};
  font-weight: normal;
`;Object.defineProperty,Object.getOwnPropertyDescriptor;let Pp=class extends e.Component{constructor(e){super(e),this.switchItem=({idx:e})=>{this.props.items&&void 0!==e&&this.setState({activeItemIdx:e})},this.state={activeItemIdx:0}}render(){const{items:t}=this.props;if(!t||!t.length)return null;const r=({children:t})=>this.props.label?e.createElement(na,null,e.createElement(ra,null,this.props.label),t):t;return e.createElement(e.Fragment,null,e.createElement(r,null,this.props.renderDropdown({value:this.props.options[this.state.activeItemIdx].value,options:this.props.options,onChange:this.switchItem,ariaLabel:this.props.label||"Callback"})),this.props.children(t[this.state.activeItemIdx]))}};Pp=((e,t,r,n)=>{for(var o,i=t,s=e.length-1;s>=0;s--)(o=e[s])&&(i=o(i)||i);return i})([la.observer],Pp);var Ip=Object.defineProperty,Tp=Object.defineProperties,_p=(Object.getOwnPropertyDescriptor,Object.getOwnPropertyDescriptors),Lp=Object.getOwnPropertySymbols,Dp=Object.prototype.hasOwnProperty,zp=Object.prototype.propertyIsEnumerable,Mp=(e,t,r)=>t in e?Ip(e,t,{enumerable:!0,configurable:!0,writable:!0,value:r}):e[t]=r;let Np=class extends e.Component{constructor(){super(...arguments),this.renderDropdown=t=>{return e.createElement(xs,(r=((e,t)=>{for(var r in t||(t={}))Dp.call(t,r)&&Mp(e,r,t[r]);if(Lp)for(var r of Lp(t))zp.call(t,r)&&Mp(e,r,t[r]);return e})({Label:ta,Dropdown:oa},t),Tp(r,_p({variant:"dark"}))));var r}}render(){const t=this.props.content;return void 0===t?null:e.createElement(Zc,{content:t,renderDropdown:this.renderDropdown,withLabel:!0},(t=>e.createElement(sa,{key:"samples",mediaType:t,renderDropdown:this.renderDropdown})))}};Np=((e,t,r,n)=>{for(var o,i=t,s=e.length-1;s>=0;s--)(o=e[s])&&(i=o(i)||i);return i})([la.observer],Np);class qp extends e.Component{render(){const t=this.props.callback.codeSamples.find((e=>go(e)));return t?e.createElement(Fp,null,e.createElement(Np,{content:t.requestBodyContent})):null}}const Fp=re.div`
  margin-top: 15px;
`;var Bp=Object.defineProperty,Qp=Object.defineProperties,Up=(Object.getOwnPropertyDescriptor,Object.getOwnPropertyDescriptors),Wp=Object.getOwnPropertySymbols,Vp=Object.prototype.hasOwnProperty,Hp=Object.prototype.propertyIsEnumerable,Jp=(e,t,r)=>t in e?Bp(e,t,{enumerable:!0,configurable:!0,writable:!0,value:r}):e[t]=r;let Yp=class extends e.Component{constructor(){super(...arguments),this.renderDropdown=t=>{return e.createElement(xs,(r=((e,t)=>{for(var r in t||(t={}))Vp.call(t,r)&&Jp(e,r,t[r]);if(Wp)for(var r of Wp(t))Hp.call(t,r)&&Jp(e,r,t[r]);return e})({Label:ta,Dropdown:oa},t),Qp(r,Up({variant:"dark"}))));var r}}render(){const{callbacks:t}=this.props;if(!t||0===t.length)return null;const r=t.map((e=>e.operations.map((e=>e)))).reduce(((e,t)=>e.concat(t)),[]);if(!r.some((e=>e.codeSamples.length>0)))return null;const n=r.map(((e,t)=>({value:`${e.httpVerb.toUpperCase()}: ${e.name}`,idx:t})));return e.createElement("div",null,e.createElement(yi,null," Callback payload samples "),e.createElement(Zp,null,e.createElement(Pp,{items:r,renderDropdown:this.renderDropdown,label:"Callback",options:n},(t=>e.createElement(qp,{key:"callbackPayloadSample",callback:t,renderDropdown:this.renderDropdown})))))}};Yp.contextType=de,Yp=((e,t,r,n)=>{for(var o,i=t,s=e.length-1;s>=0;s--)(o=e[s])&&(i=o(i)||i);return i})([la.observer],Yp);const Zp=re.div`
  background: ${({theme:e})=>e.codeBlock.backgroundColor};
  padding: ${e=>4*e.theme.spacing.unit}px;
`;Object.defineProperty,Object.getOwnPropertyDescriptor;let Gp=class extends e.Component{render(){const{operation:t}=this.props,r=t.codeSamples,n=r.length>0,o=1===r.length&&this.context.hideSingleRequestSampleTab;return n&&e.createElement("div",null,e.createElement(yi,null," ",L("requestSamples")," "),e.createElement(Wi,{defaultIndex:0},e.createElement(Ui.TabList,{hidden:o},r.map((t=>e.createElement(Ui.Tab,{key:t.lang+"_"+(t.label||"")},void 0!==t.label?t.label:t.lang)))),r.map((t=>e.createElement(Ui.TabPanel,{key:t.lang+"_"+(t.label||"")},go(t)?e.createElement("div",null,e.createElement(Np,{content:t.requestBodyContent})):e.createElement(Gs,{lang:t.lang,source:t.source}))))))||null}};Gp.contextType=de,Gp=((e,t,r,n)=>{for(var o,i=t,s=e.length-1;s>=0;s--)(o=e[s])&&(i=o(i)||i);return i})([la.observer],Gp);Object.defineProperty,Object.getOwnPropertyDescriptor;let Xp=class extends e.Component{render(){const{operation:t}=this.props,r=t.responses.filter((e=>e.content&&e.content.hasSample));return r.length>0&&e.createElement("div",null,e.createElement(yi,null," ",L("responseSamples")," "),e.createElement(Wi,{defaultIndex:0},e.createElement(Ui.TabList,null,r.map((t=>e.createElement(Ui.Tab,{className:"tab-"+t.type,key:t.code},t.code)))),r.map((t=>e.createElement(Ui.TabPanel,{key:t.code},e.createElement("div",null,e.createElement(Np,{content:t.content})))))))||null}};Xp=((e,t,r,n)=>{for(var o,i=t,s=e.length-1;s>=0;s--)(o=e[s])&&(i=o(i)||i);return i})([la.observer],Xp);var Kp=Object.defineProperty,eu=Object.defineProperties,tu=Object.getOwnPropertyDescriptors,ru=Object.getOwnPropertySymbols,nu=Object.prototype.hasOwnProperty,ou=Object.prototype.propertyIsEnumerable,iu=(e,t,r)=>t in e?Kp(e,t,{enumerable:!0,configurable:!0,writable:!0,value:r}):e[t]=r;const su=re.div`
  margin-bottom: ${({theme:e})=>6*e.spacing.unit}px;
`,au=(0,la.observer)((({operation:t})=>{const{name:r,description:n,deprecated:o,externalDocs:i,isWebhook:s,httpVerb:a}=t,l=!(!n&&!i),{showWebhookVerb:c}=e.useContext(de);return e.createElement(de.Consumer,null,(p=>{return e.createElement(di,(u=((e,t)=>{for(var r in t||(t={}))nu.call(t,r)&&iu(e,r,t[r]);if(ru)for(var r of ru(t))ou.call(t,r)&&iu(e,r,t[r]);return e})({},{[ti]:t.operationHash}),d={id:t.operationHash},eu(u,tu(d))),e.createElement(li,null,e.createElement(gi,null,e.createElement($i,{to:t.id}),r," ",o&&e.createElement(Ci,{type:"warning"}," Deprecated "),s&&e.createElement(Ci,{type:"primary"}," ","Webhook ",c&&a&&"| "+a.toUpperCase())),p.pathInMiddlePanel&&!s&&e.createElement(Jc,{operation:t,inverted:!0}),l&&e.createElement(su,null,void 0!==n&&e.createElement(As,{source:n}),i&&e.createElement(Ea,{externalDocs:i})),e.createElement(ja,{extensions:t.extensions}),e.createElement(Op,{securities:t.security}),e.createElement(np,{parameters:t.parameters,body:t.requestBody}),e.createElement(vp,{responses:t.responses}),e.createElement(Cp,{callbacks:t.callbacks})),e.createElement(ui,null,!p.pathInMiddlePanel&&!s&&e.createElement(Jc,{operation:t}),e.createElement(Gp,{operation:t}),e.createElement(Xp,{operation:t}),e.createElement(Yp,{callbacks:t.callbacks})));var u,d}))}));var lu=Object.defineProperty,cu=Object.getOwnPropertyDescriptor,pu=Object.getOwnPropertySymbols,uu=Object.prototype.hasOwnProperty,du=Object.prototype.propertyIsEnumerable,hu=(e,t,r)=>t in e?lu(e,t,{enumerable:!0,configurable:!0,writable:!0,value:r}):e[t]=r,mu=(e,t,r,n)=>{for(var o,i=n>1?void 0:n?cu(t,r):t,s=e.length-1;s>=0;s--)(o=e[s])&&(i=(n?o(t,r,i):o(i))||i);return n&&i&&lu(t,r,i),i};let fu=class extends e.Component{render(){const t=this.props.items;return 0===t.length?null:t.map((t=>e.createElement(gu,{key:t.id,item:t})))}};fu=mu([la.observer],fu);let gu=class extends e.Component{render(){const t=this.props.item;let r;const{type:n}=t;switch(n){case"group":r=null;break;case"tag":case"section":default:r=e.createElement(bu,((e,t)=>{for(var r in t||(t={}))uu.call(t,r)&&hu(e,r,t[r]);if(pu)for(var r of pu(t))du.call(t,r)&&hu(e,r,t[r]);return e})({},this.props));break;case"operation":r=e.createElement(xu,{item:t})}return e.createElement(e.Fragment,null,r&&e.createElement(ci,{id:t.id,underlined:"operation"===t.type},r),t.items&&e.createElement(fu,{items:t.items}))}};gu=mu([la.observer],gu);const yu=t=>e.createElement(li,{compact:!0},t);let bu=class extends e.Component{render(){const{name:t,description:r,externalDocs:n,level:o}=this.props.item,i=2===o?gi:fi;return e.createElement(e.Fragment,null,e.createElement(di,null,e.createElement(li,{compact:!1},e.createElement(i,null,e.createElement($i,{to:this.props.item.id}),t))),e.createElement(Oc,{parentId:this.props.item.id,source:r||"",htmlWrap:yu}),n&&e.createElement(di,null,e.createElement(li,null,e.createElement(Ea,{externalDocs:n}))))}};bu=mu([la.observer],bu);let xu=class extends e.Component{render(){return e.createElement(au,{operation:this.props.item})}};xu=mu([la.observer],xu);var vu=Object.defineProperty,wu=Object.defineProperties,ku=(Object.getOwnPropertyDescriptor,Object.getOwnPropertyDescriptors),Ou=Object.getOwnPropertySymbols,Eu=Object.prototype.hasOwnProperty,Su=Object.prototype.propertyIsEnumerable,$u=(e,t,r)=>t in e?vu(e,t,{enumerable:!0,configurable:!0,writable:!0,value:r}):e[t]=r;let Ru=class extends e.Component{constructor(){super(...arguments),this.ref=e.createRef(),this.activate=e=>{this.props.onActivate(this.props.item),e.stopPropagation()}}componentDidMount(){this.scrollIntoViewIfActive()}componentDidUpdate(){this.scrollIntoViewIfActive()}scrollIntoViewIfActive(){this.props.item.active&&this.ref.current&&u(this.ref.current)}render(){const{item:t,withoutChildren:r}=this.props;return e.createElement(Ac,{onClick:this.activate,depth:t.depth,"data-item-id":t.id},"operation"===t.type?e.createElement(ju,(n=((e,t)=>{for(var r in t||(t={}))Eu.call(t,r)&&$u(e,r,t[r]);if(Ou)for(var r of Ou(t))Su.call(t,r)&&$u(e,r,t[r]);return e})({},this.props),wu(n,ku({item:t})))):e.createElement(Ic,{depth:t.depth,active:t.active,type:t.type,ref:this.ref},e.createElement(Tc,{title:t.sidebarLabel},t.sidebarLabel,this.props.children),t.depth>0&&t.items.length>0&&e.createElement(ji,{float:"right",direction:t.expanded?"down":"right"})||null),!r&&t.items&&t.items.length>0&&e.createElement(_u,{expanded:t.expanded,items:t.items,onActivate:this.props.onActivate}));var n}};Ru=((e,t,r,n)=>{for(var o,i=t,s=e.length-1;s>=0;s--)(o=e[s])&&(i=o(i)||i);return i})([la.observer],Ru);const ju=(0,la.observer)((t=>{const{item:r}=t,n=e.createRef(),{showWebhookVerb:o}=e.useContext(de);return e.useEffect((()=>{t.item.active&&n.current&&u(n.current)}),[t.item.active,n]),e.createElement(Ic,{depth:r.depth,active:r.active,deprecated:r.deprecated,ref:n},r.isWebhook?e.createElement(Rc,{type:"hook"},o?r.httpVerb:L("webhook")):e.createElement(Rc,{type:r.httpVerb},xt(r.httpVerb)),e.createElement(Tc,{width:"calc(100% - 38px)"},r.sidebarLabel,t.children))}));var Cu=Object.defineProperty,Au=(Object.getOwnPropertyDescriptor,Object.getOwnPropertySymbols),Pu=Object.prototype.hasOwnProperty,Iu=Object.prototype.propertyIsEnumerable,Tu=(e,t,r)=>t in e?Cu(e,t,{enumerable:!0,configurable:!0,writable:!0,value:r}):e[t]=r;let _u=class extends e.Component{render(){const{items:t,root:r,className:n}=this.props,o=null==this.props.expanded||this.props.expanded;return e.createElement(Cc,((e,t)=>{for(var r in t||(t={}))Pu.call(t,r)&&Tu(e,r,t[r]);if(Au)for(var r of Au(t))Iu.call(t,r)&&Tu(e,r,t[r]);return e})({className:n,style:this.props.style,expanded:o},r?{role:"menu"}:{}),t.map(((t,r)=>e.createElement(Ru,{key:r,item:t,onActivate:this.props.onActivate}))))}};function Lu(){const[t,r]=(0,e.useState)(!1);return(0,e.useEffect)((()=>{r(!0)}),[]),t?e.createElement("img",{alt:"redocly logo",onError:()=>r(!1),src:"https://cdn.redoc.ly/redoc/logo-mini.svg"}):null}_u=((e,t,r,n)=>{for(var o,i=t,s=e.length-1;s>=0;s--)(o=e[s])&&(i=o(i)||i);return i})([la.observer],_u);Object.defineProperty,Object.getOwnPropertyDescriptor;let Du=class extends e.Component{constructor(){super(...arguments),this.activate=e=>{if(e&&e.active&&this.context.menuToggle)return e.expanded?e.collapse():e.expand();this.props.menu.activateAndScroll(e,!0),setTimeout((()=>{this._updateScroll&&this._updateScroll()}))},this.saveScrollUpdate=e=>{this._updateScroll=e}}render(){const t=this.props.menu;return e.createElement(ls,{updateFn:this.saveScrollUpdate,className:this.props.className,options:{wheelPropagation:!1}},e.createElement(_u,{items:t.items,onActivate:this.activate,root:!0}),e.createElement(_c,null,e.createElement("a",{target:"_blank",rel:"noopener noreferrer",href:"https://redocly.com/redoc/"},e.createElement(Lu,null),"API docs by Redocly")))}};Du.contextType=de,Du=((e,t,r,n)=>{for(var o,i=t,s=e.length-1;s>=0;s--)(o=e[s])&&(i=o(i)||i);return i})([la.observer],Du);const zu=({open:t})=>{const r=t?8:-4;return e.createElement(Nu,null,e.createElement(Mu,{size:15,style:{transform:`translate(2px, ${r}px) rotate(180deg)`,transition:"transform 0.2s ease"}}),e.createElement(Mu,{size:15,style:{transform:`translate(2px, ${0-r}px)`,transition:"transform 0.2s ease"}}))},Mu=({size:t=10,className:r="",style:n})=>e.createElement("svg",{className:r,style:n||{},viewBox:"0 0 926.23699 573.74994",version:"1.1",x:"0px",y:"0px",width:t,height:t},e.createElement("g",{transform:"translate(904.92214,-879.1482)"},e.createElement("path",{d:"\n          m -673.67664,1221.6502 -231.2455,-231.24803 55.6165,\n          -55.627 c 30.5891,-30.59485 56.1806,-55.627 56.8701,-55.627 0.6894,\n          0 79.8637,78.60862 175.9427,174.68583 l 174.6892,174.6858 174.6892,\n          -174.6858 c 96.079,-96.07721 175.253196,-174.68583 175.942696,\n          -174.68583 0.6895,0 26.281,25.03215 56.8701,\n          55.627 l 55.6165,55.627 -231.245496,231.24803 c -127.185,127.1864\n          -231.5279,231.248 -231.873,231.248 -0.3451,0 -104.688,\n          -104.0616 -231.873,-231.248 z\n        ",fill:"currentColor"}))),Nu=re.div`
  user-select: none;
  width: 20px;
  height: 20px;
  align-self: center;
  ...
  flex-direction: column;
  color: ${e=>e.theme.colors.primary.main};
`;Object.defineProperty,Object.getOwnPropertyDescriptor;let qu;l&&(qu=r(322));const Fu=qu&&qu(),Bu=re.div`
...
`;let Uu=class extends e.Component{constructor(){super(...arguments),this.state={offsetTop:"0px"},this.toggleNavMenu=()=>{this.props.menu.toggleSidebar()}}componentDidMount(){Fu&&Fu.add(this.stickyElement),this.setState({offsetTop:this.getScrollYOffset(this.context)})}componentWillUnmount(){Fu&&Fu.remove(this.stickyElement)}getScrollYOffset(e){let t;return t=void 0!==this.props.scrollYOffset?H.normalizeScrollYOffset(this.props.scrollYOffset)():e.scrollYOffset(),t+"px"}render(){const t=this.props.menu.sideBarOpened,r=this.state.offsetTop;return e.createElement(e.Fragment,null,e.createElement(Bu,{open:t,className:this.props.className,style:{top:r,height:`calc(100vh - ${r})`},ref:e=>{this.stickyElement=e}},this.props.children),!this.context.hideFab&&e.createElement(Qu,{onClick:this.toggleNavMenu},e.createElement(zu,{open:t})))}};Uu.contextType=de,Uu=((e,t,r,n)=>{for(var o,i=t,s=e.length-1;s>=0;s--)(o=e[s])&&(i=o(i)||i);return i})([la.observer],Uu);const Wu=re.header`
  position: relative;
  width: 100%;
  z-index: 99;
`,Vu=re.div`
...
`,Zu=re.div`
  padding: 5px 0;
`,Gu=re.input.attrs((()=>({className:"search-input"})))`
...
`,ed=re.i`
  ...
  font-style: normal;
  color: '#666';
`;var td=Object.defineProperty,rd=Object.getOwnPropertyDescriptor;class nd extends e.PureComponent{constructor(e){super(e),this.activeItemRef=null,this.clear=()=>{this.setState({results:[],noResults:!1,term:"",activeItemIdx:-1}),this.props.marker.unmark()},this.handleKeyDown=e=>{if(27===e.keyCode&&this.clear(),40===e.keyCode&&(this.setState({activeItemIdx:Math.min(this.state.activeItemIdx+1,this.state.results.length-1)}),e.preventDefault()),38===e.keyCode&&(this.setState({activeItemIdx:Math.max(0,this.state.activeItemIdx-1)}),e.preventDefault()),13===e.keyCode){const e=this.state.results[this.state.activeItemIdx];if(e){const t=this.props.getItemById(e.meta);t&&this.props.onActivate(t)}}},this.search=e=>{const{minCharacterLengthToInitSearch:t}=this.context,r=e.target.value;r.length<t?this.clearResults(r):this.setState({term:r},(()=>this.searchCallback(this.state.term)))},this.state={results:[],noResults:!1,term:"",activeItemIdx:-1}}clearResults(e){this.setState({results:[],noResults:!1,term:e}),this.props.marker.unmark()}setResults(e,t){this.setState({results:e,noResults:0===e.length}),this.props.marker.mark(t)}searchCallback(e){this.props.search.search(e).then((t=>{this.setResults(t,e)}))}render(){const{activeItemIdx:t}=this.state,r=this.state.results.filter((e=>this.props.getItemById(e.meta))).map((e=>({item:this.props.getItemById(e.meta),score:e.score}))).sort(((e,t)=>t.score-e.score));return e.createElement(Zu,{role:"search","data-role":"redoc-search"},this.state.term&&e.createElement(ed,{onClick:this.clear},"×"),e.createElement(Xu,null),e.createElement(Gu,{value:this.state.term,onKeyDown:this.handleKeyDown,placeholder:"Search...","aria-label":"Search",type:"text",onChange:this.search}),r.length>0&&e.createElement(ls,{options:{wheelPropagation:!1}},e.createElement(Ku,{"data-role":"search:results"},r.map(((r,n)=>e.createElement(Ru,{item:Object.create(r.item,{active:{value:n===t}}),onActivate:this.props.onActivate,withoutChildren:!0,key:r.item.id,"data-role":"search:result"}))))),this.state.term&&this.state.noResults?e.createElement(Ku,{"data-role":"search:results"},L("noResultsFound")):null)}}nd.contextType=de,((e,t,r,n)=>{for(var o,i=rd(t,r),s=e.length-1;s>=0;s--)(o=e[s])&&(i=o(t,r,i)||i);i&&td(t,r,i)})([we.bind,(0,we.debounce)(400)],nd.prototype,"searchCallback");class od extends e.Component{componentDidMount(){this.props.store.onDidMount()}componentWillUnmount(){this.props.store.dispose()}render(){const{store:{spec:t,menu:r,options:n,search:o,marker:i}}=this.props,s=this.props.store;return e.createElement(ee,{theme:n.theme},e.createElement(vi,{value:s},e.createElement(he,{value:n},e.createElement(Wu,null,e.createElement(ue.UnifiedNav,{position:"relative",property:{name:"DOCS",searchParams:[]}})),e.createElement(Hu,{className:"redoc-wrap"},e.createElement(Uu,{menu:r,className:"menu-content"},e.createElement(gc,{info:t.info}),e.createElement(Vu,null,s.spec.info.title),!n.disableSearch&&e.createElement(nd,{search:o,marker:i,getItemById:r.getItemById,onActivate:r.activateAndScroll})||null,e.createElement(Du,{menu:r})),e.createElement(Ju,{className:"api-content"},e.createElement(dc,{store:s}),e.createElement(fu,{items:r.items})),e.createElement(Yu,null)),e.createElement(ue.UnifiedFooter,{hideLocale:!0}))))}}od.propTypes={store:pe.instanceOf(ic).isRequired};const id=function(t){const{spec:n,specUrl:o,options:i={},onLoaded:s}=t,a=W(i.hideLoading,!1),l=new H(i);if(void 0!==l.nonce)try{r.nc=l.nonce}catch(e){}return e.createElement(ie,null,e.createElement(ki,{spec:n,specUrl:o,options:i,onLoaded:s},(({loading:t,store:r})=>t?a?null:e.createElement(ce,{color:l.theme.colors.primary.main}):e.createElement(od,{store:r}))))}}(),n}()}));
