...
`;Object.defineProperty,Object.getOwnPropertyDescriptor;let gc=class extends e.Component{render(){const{info:t}=this.props,r=t["x-logo"];if(!r||!r.url)return null;const n=r.href||t.contact&&t.contact.url,o=r.altText?r.altText:"logo",i=e.createElement(hc,{src:r.url,alt:o});return e.createElement(mc,{style:{backgroundColor:r.backgroundColor}},n?(s=n,t=>e.createElement(fc,{href:s},t))(i):i);var s}};gc=((e,t,r,n)=>{for(var o,i=t,s=e.length-1;s>=0;s--)(o=e[s])&&(i=o(i)||i);return i})([la.observer],gc);var yc=Object.defineProperty,bc=Object.getOwnPropertySymbols,xc=Object.prototype.hasOwnProperty,vc=Object.prototype.propertyIsEnumerable,wc=(e,t,r)=>t in e?yc(e,t,{enumerable:!0,configurable:!0,writable:!0,value:r}):e[t]=r,kc=(e,t)=>{for(var r in t||(t={}))xc.call(t,r)&&wc(e,r,t[r]);if(bc)for(var r of bc(t))vc.call(t,r)&&wc(e,r,t[r]);return e};class Ec extends e.Component{render(){return e.createElement(me,null,(t=>e.createElement(wi,null,(e=>this.renderWithOptionsAndStore(t,e)))))}renderWithOptionsAndStore(t,r){const{source:n,htmlWrap:o=(e=>e)}=this.props;if(!r)throw new Error("When using components in markdown, store prop must be provided");const i=new Wr(t,this.props.parentId).renderMdWithComponents(n);return i.length?i.map(((t,n)=>{if("string"==typeof t)return e.cloneElement(o(e.createElement(js,{html:t,inline:!1,compact:!1})),{key:n});const i=t.component;return e.createElement(i,kc({key:n},kc(kc({},t.props),t.propsSelector(r))))})):null}}var Oc=require("classnames"),$c=r.n(Oc);function Sc(e,t){return void 0===e?"background-color: #999999;":"string"==typeof e?`\n      background-color: ${e||"#999999"};\n    `:`\n      background-color: ${e[t].backgroundColor};\n      border-color: ${e[t].borderColor};\n      color: ${e[t].color};\n    `}const Rc=re.span.attrs((e=>({className:`operation-type ${e.type}`})))`
  ...
  ${e=>Sc(e.theme.colors.http[e.type],"light")}
`;function Cc(e,{theme:t},r){return e>1?t.sidebar.level1Items[r]:1===e?t.sidebar.groupItems[r]:""}const jc=re.ul`
  margin: 0;
  padding: 0;
...
`,Ic={0:G`
  ...
  `},Tc=re.label.attrs((e=>({role:"menuitem",className:$c()("-depth"+e.depth,{active:e.active})})))`
  cursor: pointer;
  color: ${e=>function(e){const{active:t,depth:r,isBackButton:n,theme:i}=e;return n?o.palette.gray.dark1:t?Cc(r,e,"activeTextColor"):i.sidebar.textColor}(e)};
  margin: 0;
  ...
  &:hover {
    color: ${e=>e.isBackButton?o.palette.gray.dark1:Cc(e.depth,e,"activeTextColor")};
...
`,Mc=re(Rc)`
  margin: 0 5px 0 0;
`,Fc=re((t=>{const{name:r,opened:n,className:o,onClick:i,httpVerb:s,deprecated:a}=t;return e.createElement(zc,{className:o,onClick:i||void 0},e.createElement(Mc,{type:s},xt(s)),e.createElement(Ci,{size:"1.5em",direction:n?"down":"right",float:"left"}),e.createElement(Nc,{deprecated:a},r),a?e.createElement(ji,{type:"warning"}," ",L("deprecated")," "):null)}))`
  padding: 10px;
  border-radius: 2px;
  margin-bottom: 4px;
  line-height: 1.5em;
...
`,Vc=re.span.attrs((e=>({className:`http-verb ${e.type}`})))`
  ...
  border: ${e=>e.theme.badges.border};
  border-radius: ${e=>e.theme.badges.borderRadius};
  ${e=>Sc(e.theme.colors.http[e.type],"dark")}
`,Hc=re.div`
  position: absolute;
  width: 100%;
  z-index: 100;
...
`;let Yu=class extends e.Component{constructor(){super(...arguments),this.state={offsetTop:"0px"},this.toggleNavMenu=()=>{this.props.menu.toggleSidebar()}}componentDidMount(){Wu&&Wu.add(this.stickyElement),this.setState({offsetTop:this.getScrollYOffset(this.context)})}componentWillUnmount(){Wu&&Wu.remove(this.stickyElement)}getScrollYOffset(e){let t;return t=void 0!==this.props.scrollYOffset?H.normalizeScrollYOffset(this.props.scrollYOffset)():e.scrollYOffset(),t+"px"}render(){const t=this.props.menu.sideBarOpened,r=this.state.offsetTop;return e.createElement(e.Fragment,null,e.createElement(Vu,{open:t,className:this.props.className,style:{top:r,height:`calc(100vh - ${r})`},ref:e=>{this.stickyElement=e}},this.props.children),!this.context.hideFab&&e.createElement(Hu,{onClick:this.toggleNavMenu},e.createElement(qu,{open:t})))}};Yu.contextType=de,Yu=((e,t,r,n)=>{for(var o,i=t,s=e.length-1;s>=0;s--)(o=e[s])&&(i=o(i)||i);return i})([la.observer],Yu);const Ju=re.header`
  position: relative;
  width: 100%;
  z-index: 99;
`,Zu=re.div`
...
`,ud=re.button.attrs({"aria-labelledby":"View a different version of documentation."})`
  position: relative;
  display: flex;
  justify-content: space-between;
  align-items: center;
...
`,xd=re.li.attrs((({selected:e})=>({role:"option","aria-selected":e,tabIndex:"0"})))`
  display: flex;
  width: 100%;
  outline: none;
...
`,wd=G`
  ...
  z-index: 2;
  background-color: ${o.palette.white};
`,kd=re.div.attrs({role:"listbox","aria-labelledby":"View a different version of documentation.",tabIndex:"-1"})`
  ${e=>e.open?wd:"display: none;"}
`,Ed=re.span`
  width: 16px;
  height: 16px;
  margin-right: 6px;
`,Od=re.svg`
  ...
  flex-shrink: 0;
  margin-right: 6px;
`;var $d=()=>e.createElement(Od,{height:16,width:16,role:"img","aria-label":"Checkmark Icon",viewBox:"0 0 16 16"},e.createElement("path",{fillRule:"evenodd",clipRule:"evenodd",d:"M6.30583 9.05037L11.7611 3.59509C12.1516 3.20457 12.7848 3.20457 13.1753 3.59509L13.8824 4.3022C14.273 4.69273 14.273 5.32589 13.8824 5.71642L6.81525 12.7836C6.38819 13.2106 5.68292 13.1646 5.31505 12.6856L2.26638 8.71605C1.92998 8.27804 2.01235 7.65025 2.45036 7.31385L3.04518 6.85702C3.59269 6.43652 4.37742 6.53949 4.79792 7.087L6.30583 9.05037Z",fill:"currentColor"}));const Sd=({option:t,value:r,selected:n,onClick:o,focused:i})=>e.createElement(xd,{onClick:()=>o(r),onKeyPress:e=>{"Enter"!==e.key&&" "!==e.key||o(r)},selected:n,focused:i},n?e.createElement($d,null):e.createElement(Ed,null),e.createElement(vd,null,t)),Rd=e.memo((({resourceVersions:t,active:r,description:n,rootUrl:o})=>{const i=t.indexOf(r.resourceVersion),[s,a]=e.useState(!1),[l,c]=e.useState(-1),[p,u]=e.useState(i),d=e.useRef(null),h=t.map(((r,n)=>e.createElement(Sd,{key:`option-${n}`,selected:n===p,value:r,option:`${r}${n===t.length-1?" (latest)":""}`,onClick:e=>g(n,e),focused:n===l})));var m,f;m=d,f=()=>{s&&a(!1),c(0)},(0,e.useEffect)((()=>{function e(e){m.current&&!m.current.contains(e.target)&&f()}return document.addEventListener("mousedown",e),()=>{document.removeEventListener("mousedown",e)}}),[m,f]);const g=(e,t)=>{if(e===p)return a(!1);let r=`${o}/${t}`;const n=window.location.href.indexOf("#tag");return n>-1&&(r+=window.location.href.slice(n)),window.location.href=r,u(e),a(!1)};return e.createElement(cd,{onKeyDown:e=>{const{key:r,shiftKey:n}=e;if("ArrowDown"===r||"Tab"===r&&!n){if(l===t.length)return;-1===l?a(!0):l===t.length-1&&a(!1),c(l+1)}else if("ArrowUp"===r||"Tab"===r&&n){if(-1===l)return;l===t.length?a(!0):0===l&&a(!1),c(l-1)}},ref:d},e.createElement(pd,null,e.createElement(dd,null,"Resource Version:"),n&&e.createElement(hd,null,n),e.createElement(ud,{onClick:()=>a(!s)},e.createElement(fd,null,e.createElement(gd,null,t[p]),e.createElement(ld,{open:s})))),e.createElement(kd,{open:s},e.createElement("div",null,e.createElement(md,null,h))))}));var Cd=Object.defineProperty,jd=Object.getOwnPropertySymbols,Ad=Object.prototype.hasOwnProperty,Pd=Object.prototype.propertyIsEnumerable,Id=(e,t,r)=>t in e?Cd(e,t,{enumerable:!0,configurable:!0,writable:!0,value:r}):e[t]=r;class Td extends e.Component{componentDidMount(){this.props.store.onDidMount()}componentWillUnmount(){this.props.store.dispose()}render(){const{store:{spec:t,menu:r,options:n,search:o,marker:i}}=this.props,s=this.props.store;return e.createElement(ee,{theme:n.theme},e.createElement(vi,{value:s},e.createElement(he,{value:n},e.createElement(Ju,null,e.createElement(ue.UnifiedNav,{position:"relative",property:{name:"DOCS",searchParams:[]}})),e.createElement(Gu,{className:"redoc-wrap"},e.createElement(Yu,{menu:r,className:"menu-content"},e.createElement(gc,{info:t.info}),e.createElement(Fu,{backNavigationPath:n.backNavigationPath,siteTitle:n.siteTitle}),e.createElement(Zu,null,s.spec.info.title,n.versionData&&` ${n.versionData.active.apiVersion}`),!n.disableSearch&&e.createElement(ad,{search:o,marker:i,getItemById:r.getItemById,onActivate:r.activateAndScroll})||null,n.versionData&&e.createElement(Rd,((e,t)=>{for(var r in t||(t={}))Ad.call(t,r)&&Id(e,r,t[r]);if(jd)for(var r of jd(t))Pd.call(t,r)&&Id(e,r,t[r]);return e})({},n.versionData)),e.createElement(Mu,{menu:r})),e.createElement(Xu,{className:"api-content"},e.createElement(dc,{store:s}),e.createElement(bu,{items:r.items})),e.createElement(Ku,null)),e.createElement(ue.UnifiedFooter,{hideLocale:!0}))))}}Td.propTypes={store:pe.instanceOf(ic).isRequired};const _d=function(t){const{spec:n,specUrl:o,options:i={},onLoaded:s}=t,a=W(i.hideLoading,!1),l=new H(i);if(void 0!==l.nonce)try{r.nc=l.nonce}catch(e){}return e.createElement(ie,null,e.createElement(ki,{spec:n,specUrl:o,options:i,onLoaded:s},(({loading:t,store:r})=>t?a?null:e.createElement(ce,{color:l.theme.colors.primary.main}):e.createElement(Td,{store:r}))))}}(),n}()}));
