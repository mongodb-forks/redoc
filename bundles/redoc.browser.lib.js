  ...
  return (function () {
            ...
            return i(
              ...
              new Promise(function (r, n) {
                ...
                if (
                  ...
                  let t = {};
                  (t.url = e.basePath), L(t), o.servers || (o.servers = []), o.servers.push(t);
                }
                if (
                  (delete o.host,
                  delete o.basePath,
    ...
    return (
      (function () {
        ...
        var e = require('react'),
          t = require('polished'),
          o = require('@leafygreen-ui/palette');
        const i = '"Euclid Circular A", Akzidenz, "Helvetica Neue", Helvetica, Arial, sans-serif',
          s = {
            spacing: {
              unit: 4,
            ...
            colors: {
              ...
              responses: {
                success: {
                  ...
                  backgroundColor: o.palette.green.light3,
                  tabTextColor: o.palette.green.base,
                },
                error: {
                  color: o.palette.red.base,
                  backgroundColor: o.palette.red.light3,
                  tabTextColor: o.palette.red.base,
                },
                redirect: {
              ...
              http: {
                get: {
                  light: {
                    backgroundColor: o.palette.blue.light3,
                    borderColor: o.palette.blue.light2,
                    color: o.palette.blue.dark1,
                  },
                  dark: {
                    backgroundColor: o.palette.blue.dark2,
                    borderColor: o.palette.blue.dark1,
                    color: o.palette.blue.light2,
                  },
                },
                post: {
                  light: {
                    backgroundColor: o.palette.green.light3,
                    borderColor: o.palette.green.light2,
                    color: o.palette.green.dark2,
                  },
                  dark: {
                    backgroundColor: o.palette.green.dark3,
                    borderColor: o.palette.green.dark2,
                    color: o.palette.green.base,
                  },
                },
                put: {
                  light: {
                    backgroundColor: o.palette.yellow.light3,
                    borderColor: o.palette.yellow.light2,
                    color: o.palette.yellow.dark2,
                  },
                  dark: {
                    backgroundColor: o.palette.yellow.dark3,
                    borderColor: o.palette.yellow.dark2,
                    color: o.palette.yellow.light2,
                  },
                },
                options: '#947014',
                patch: {
                ...
                delete: {
                  light: {
                    backgroundColor: o.palette.red.light3,
                    borderColor: o.palette.red.light2,
                    color: o.palette.red.dark2,
                  },
                  dark: {
                    backgroundColor: o.palette.red.dark3,
                    borderColor: o.palette.red.dark2,
                    color: o.palette.red.light2,
                  },
                },
                basic: '#707070',
                link: '#07818F',
            ...
            schema: {
              linesColor: o.palette.black,
              defaultDetailsWidth: '75%',
              typeNameColor: o.palette.gray.dark3,
              typeTitleColor: e => e.schema.typeNameColor,
              requireLabelColor: o.palette.red.base,
            ...
            typography: {
              ...
              optimizeSpeed: !0,
              headings: { fontFamily: i, fontWeight: '400', lineHeight: '1.6em' },
              code: {
                fontSize: '13px',
                ...
                backgroundColor: o.palette.gray.light3,
                wrap: !1,
              },
              links: {
                color: o.palette.blue.base,
                visited: o.palette.blue.base,
                hover: o.palette.blue.base,
                textDecoration: 'auto',
            ...
            sidebar: {
              width: '268px',
              backgroundColor: o.palette.gray.light3,
              textColor: o.palette.black,
              activeTextColor: o.palette.green.dark3,
              groupItems: {
                activeBackgroundColor: o.palette.green.light3,
            ...
            rightPanel: {
              backgroundColor: o.palette.black,
              width: '40%',
              textColor: '#ffffff',
              servers: {
                overlay: { backgroundColor: o.palette.gray.dark3, textColor: o.palette.white },
                url: { backgroundColor: o.palette.gray.dark3 },
              },
            },
            codeBlock: { backgroundColor: o.palette.gray.dark3 },
            fab: { backgroundColor: '#f2f2f2', color: '#0065FB' },
            badges: { border: '1px solid', borderRadius: '5px' },
          };
        var a = s;
        const l = 'undefined' != typeof window && 'HTMLElement' in window;
        function c(e) {
            ...
            return void 0 === r
              ...
              : (k(e) &&
                  ...
                  Object.keys(r).forEach(t => {
                    k(r[t]) ? (e[t] || (e[t] = {}), v(e[t], r[t])) : (e[t] = r[t]);
                  }),
                v(e, ...t));
          },
        ...
        var D = (e => (
          ...
          Q = (e, t, r) =>
            t in e
              ...
              : (e[t] = r),
          U = (e, t) => {
            for (var r in t || (t = {})) F.call(t, r) && Q(e, r, t[r]);
            if (q) for (var r of q(t)) B.call(t, r) && Q(e, r, t[r]);
            return e;
          };
        function W(e, t) {
        ...
        class H {
          ...
          constructor(e, t = {}) {
            var r, n, o, i, s;
            const l = (e = U(U({}, t), e)).theme && e.theme.extensionsHook;
            var c, p;
            (null == (r = e.theme) ? void 0 : r.menu) &&
              ...
              })(v({}, a, ((c = U({}, e.theme)), M(c, N({ extensionsHook: void 0 })))))),
              (this.theme.extensionsHook = l),
              (p = e.labels),
              Object.assign(_, p),
              (this.scrollYOffset = H.normalizeScrollYOffset(e.scrollYOffset)),
              (this.hideHostname = H.normalizeHideHostname(e.hideHostname)),
              (this.expandResponses = H.normalizeExpandResponses(e.expandResponses)),
              (this.requiredPropsFirst = W(e.requiredPropsFirst)),
              (this.sortPropsAlphabetically = W(e.sortPropsAlphabetically)),
              (this.sortEnumValuesAlphabetically = W(e.sortEnumValuesAlphabetically)),
              (this.sortOperationsAlphabetically = W(e.sortOperationsAlphabetically)),
              (this.sortTagsAlphabetically = W(e.sortTagsAlphabetically)),
              (this.nativeScrollbars = W(e.nativeScrollbars)),
              (this.pathInMiddlePanel = W(e.pathInMiddlePanel)),
              (this.untrustedSpec = W(e.untrustedSpec)),
              (this.hideDownloadButton = W(e.hideDownloadButton)),
              (this.downloadFileName = e.downloadFileName),
              (this.downloadDefinitionUrl = e.downloadDefinitionUrl),
              (this.disableSearch = W(e.disableSearch)),
              (this.onlyRequiredInSamples = W(e.onlyRequiredInSamples)),
              (this.showExtensions = H.normalizeShowExtensions(e.showExtensions)),
              (this.sideNavStyle = H.normalizeSideNavStyle(e.sideNavStyle)),
              (this.hideSingleRequestSampleTab = W(e.hideSingleRequestSampleTab)),
              (this.menuToggle = W(e.menuToggle, !0)),
              (this.jsonSampleExpandLevel = H.normalizeJsonSampleExpandLevel(
                e.jsonSampleExpandLevel,
              )),
              (this.enumSkipQuotes = W(e.enumSkipQuotes)),
              (this.hideSchemaTitles = W(e.hideSchemaTitles)),
              (this.simpleOneOfTypeLabel = W(e.simpleOneOfTypeLabel)),
              (this.payloadSampleIdx = H.normalizePayloadSampleIdx(e.payloadSampleIdx)),
              (this.expandSingleSchemaField = W(e.expandSingleSchemaField)),
              (this.schemaExpansionLevel = (function (e, t = 0) {
                return 'all' === e ? 1 / 0 : V(e) || t;
              })(e.schemaExpansionLevel)),
              (this.showObjectSchemaExamples = W(e.showObjectSchemaExamples)),
              (this.showSecuritySchemeType = W(e.showSecuritySchemeType)),
              (this.hideSecuritySection = W(e.hideSecuritySection)),
              (this.unstable_ignoreMimeParameters = W(e.unstable_ignoreMimeParameters)),
              (this.allowedMdComponents = e.allowedMdComponents || {}),
              (this.expandDefaultServerVariables = W(e.expandDefaultServerVariables)),
              (this.maxDisplayedEnumValues = V(e.maxDisplayedEnumValues));
            const u = I(e.ignoreNamedSchemas)
              ? e.ignoreNamedSchemas
              : null == (s = e.ignoreNamedSchemas)
              ? void 0
              : s.split(',').map(e => e.trim());
            (this.ignoreNamedSchemas = new Set(u)),
              (this.hideSchemaPattern = W(e.hideSchemaPattern)),
              (this.generatedPayloadSamplesMaxDepth = H.normalizeGeneratedPayloadSamplesMaxDepth(
                e.generatedPayloadSamplesMaxDepth,
              )),
              (this.nonce = e.nonce),
              (this.hideFab = W(e.hideFab)),
              (this.minCharacterLengthToInitSearch = V(e.minCharacterLengthToInitSearch) || 3),
              (this.showWebhookVerb = W(e.showWebhookVerb));
          }
        }
        var J = require('styled-components'),
          Y = r.n(J);
        const { default: Z, css: G, createGlobalStyle: X, keyframes: K, ThemeProvider: ee } = J,
          te = {
            lessThan:
              (e, t, r) =>
              (...n) =>
          ...
          render() {
            return this.state.error
              ? e.createElement(
                  ...
                  e.createElement('small', null, ' Commit: ', 'b3d53177'),
                )
...
`,
  ...
  color: ${e => e.color};
`;
        class ce extends e.PureComponent {
          render() {
            return e.createElement(
              'div',
              { style: { textAlign: 'center' } },
              e.createElement(le, { color: this.props.color }, 'Loading ...'),
              e.createElement(ae, { color: this.props.color }),
            );
          }
        }
        var pe = require('prop-types'),
          ue = require('@mdb/consistent-nav');
        const de = e.createContext(new H({})),
          he = de.Provider,
          me = de.Consumer;
        var fe = require('mobx'),
          ge = require('@redocly/openapi-core/lib/bundle'),
          ye = require('@redocly/openapi-core/lib/config/config'),
          be = r(925);
        function xe(e) {
          return (
            (t = this),
            null,
            (n = function* () {
              const t = new ye.Config({}),
                n = { config: t, base: l ? window.location.href : process.cwd() };
              l && (t.resolve.http.customFetch = r.g.fetch),
              ...
              return void 0 !== o.swagger ? ve(o) : o;
            }),
            new Promise((e, r) => {
              var o = e => {
                  try {
        ...
        var we = require('decko'),
          ke = require('eventemitter3'),
          Oe = require('json-pointer');
        const Ee = Oe.parse;
        class Se {
          ...
          static dirName(e, t = 1) {
            const r = Se.parse(e);
            return Oe.compile(r.slice(0, r.length - t));
          }
          static relative(e, t) {
            const r = Se.parse(e);
          ...
          static parse(e) {
            let t = e;
            return '#' === t.charAt(0) && (t = t.substring(1)), Ee(t);
          }
          static join(e, t) {
        ...
        (Oe.parse = Se.parse), Object.assign(Se, Oe);
        var $e = r(470),
          Re = require('url-template'),
          ...
          _e = (e, t, r) =>
            t in e
              ...
              : (e[t] = r),
          Le = (e, t) => {
            for (var r in t || (t = {})) Ie.call(t, r) && _e(e, r, t[r]);
            if (Pe) for (var r of Pe(t)) Te.call(t, r) && _e(e, r, t[r]);
            return e;
          },
          De = (e, t) => Ce(e, Ae(t));
        function ze(e) {
        ...
        function Me(e) {
          return 'default' === e || b(e) || ze(e);
        }
        function Ne(e, t = !1) {
          if ('default' === e) return t ? 'error' : 'success';
          let r = 'string' == typeof e ? parseInt(e, 10) : e;
          if ((ze(e) && (r *= 100), r < 100 || r > 599)) throw new Error('invalid HTTP code');
          let n = 'success';
          return (
            r >= 300 && r < 400
              ? (n = 'redirect')
        ...
        function Ue(e) {
          if (void 0 !== e.type && !I(e.type)) return e.type;
          const t = Object.keys(Qe);
          for (const r of t) {
            const t = Qe[r];
        ...
        function Ge(e, t = {}) {
          if (I(e)) throw new Error('Payload must have fields: ' + e.toString());
        ...
        function et(e, t) {
          return e.in ? decodeURIComponent(Ke(e, t)) : t;
        }
        function tt(e) {
        ...
        const rt = /^#\/components\/(schemas|pathItems)\/([^/]+)$/;
        function nt(e) {
          return rt.test(e || '');
        }
        function ot(e) {
          var t;
          const [r] = (null == (t = null == e ? void 0 : e.match(rt)) ? void 0 : t.reverse()) || [];
          return r;
        }
        function it(e, t, r) {
          let n;
        ...
        function at(e) {
          const t = [],
            r = it('characters', e.minLength, e.maxLength);
          void 0 !== r && t.push(r);
          const n = it('items', e.minItems, e.maxItems);
          void 0 !== n && t.push(n);
          const o = it('properties', e.minProperties, e.maxProperties);
          void 0 !== o && t.push(o);
          const i = (function (e) {
            if (void 0 === e) return;
            ...
            void 0 === e
              ? j(
                  (() => {
                    ...
                    return e.endsWith('.html') ? (0, $e.dirname)(e) : e;
                  })(),
                )
              : (0, $e.dirname)(e);
          return (
        ...
        const mt = 'SecurityDefinitions',
          ft = 'security-definitions',
          gt = 'SchemaDefinition';
        let yt = 'section/Authentication/';
        function bt(e) {
          yt = e;
        }
        const xt = e => ({ delete: 'del', options: 'opts' }[e] || e);
        function vt(e) {
          return (
            e in
            {
        ...
        function wt(e, t) {
          return Object.keys(e)
            .filter(e =>
              !0 === t ? e.startsWith('x-') && !vt(e) : e.startsWith('x-') && t.indexOf(e) > -1,
            )
        ...
        function Ot(e) {
          ...
          if (r) {
            ...
            for (const e of Object.keys(r)) {
              const n = r[e];
              t[e] = De(Le({}, t[e]), { examples: n });
            }
          } else if (n) {
            t = Le({}, t);
            for (const e of Object.keys(n)) {
              const r = n[e];
              t[e] = De(Le({}, t[e]), { example: r });
            }
          }
          return t;
        }
        var Et = require('prismjs');
        ...
        function $t(e, t = 'clike') {
          t = t.toLowerCase();
          let r = Et.languages[t];
          return r || (r = Et.languages[St(t)]), Et.highlight(e.toString(), r, t);
        }
        function Rt(e) {
          return (t, r, n) => {
        ...
        var At = Object.defineProperty,
          ...
          zt = (e, t) => {
            ...
            if (Tt) for (var r of Tt(t)) Lt.call(t, r) && Dt(e, r, t[r]);
            return e;
          },
          Mt = (e, t) => Pt(e, It(t));
        const Nt = {};
        ...
        class Wt {
          constructor() {
            (this.emit = () => {
              this._emiter.emit(Ut, this.currentId);
            }),
              (this._emiter = new ke.EventEmitter()),
              this.bind();
          }
          get currentId() {
            return l ? decodeURIComponent(window.location.hash.substring(1)) : '';
          }
          linkForId(e) {
            return e ? '#' + e : '';
          }
          subscribe(e) {
            const t = this._emiter.addListener(Ut, e);
            return () => t.removeListener(Ut, e);
          }
          bind() {
            l && window.addEventListener('hashchange', this.emit, !1);
          }
          dispose() {
            l && window.removeEventListener('hashchange', this.emit);
          }
          replace(e, t = !1) {
            l &&
              null != e &&
        ...
        ((e, t, r, n) => {
          for (var o, i = Qt(t, r), s = e.length - 1; s >= 0; s--)
            (o = e[s]) && (i = o(t, r, i) || i);
          i && Bt(t, r, i);
        })([we.bind, we.debounce], Wt.prototype, 'replace');
        const Vt = new Wt();
        var Ht = require('mark.js');
        class Jt {
          constructor() {
            (this.map = new Map()), (this.prevTerm = '');
          }
          add(e) {
            this.map.set(e, new Ht(e));
          }
          delete(e) {
            this.map.delete(e);
          }
          addOnly(e) {
            ...
            for (const t of e) this.map.has(t) || this.map.set(t, new Ht(t));
          }
          clearAll() {
        ...
        function rr(e, t) {
          if (t) {
            if (Zt.test(e)) return e.replace(Gt, tr);
          } else if (Xt.test(e)) return e.replace(Kt, tr);
          return e;
        }
        const nr = /&(#(?:\d+)|(?:#x[0-9A-Fa-f]+)|(?:\w+));?/gi;
        function or(e) {
          return e.replace(nr, (e, t) =>
        ...
        function sr(e, t) {
          ...
          const r = {
            replace: (t, n) => (
              (n = (n = n.source || n).replace(ir, '$1')), (e = e.replace(t, n)), r
            ),
        ...
        function cr(e, t, r) {
          if (e) {
            let e;
            try {
              e = decodeURIComponent(or(r)).replace(ar, '').toLowerCase();
            } catch (e) {
              return null;
            }
            if (
          ...
          t &&
            ...
            (r = (function (e, t) {
              pr[' ' + e] ||
                (ur.test(e) ? (pr[' ' + e] = e + '/') : (pr[' ' + e] = yr(e, '/', !0)));
              const r = -1 === (e = pr[' ' + e]).indexOf(':');
        ...
        function vr(e, t, r, n) {
          ...
          return { type: 'image', raw: r, href: o, title: i, text: rr(s) };
        }
        class wr {
          constructor(e) {
            this.options = e || Yt;
            ...
            if (t) {
              ...
              return (
                this.options.sanitize &&
                  ((e.type = 'paragraph'),
                  (e.text = this.options.sanitizer ? this.options.sanitizer(t[0]) : rr(t[0])),
                  (e.tokens = []),
            ...
            if (t) {
              ...
              if (e.header.length === e.align.length) {
                ...
                for (s = e.rows.length, r = 0; r < s; r++)
                  e.rows[r] = gr(e.rows[r], e.header.length).map(e => ({ text: e }));
          ...
          autolink(e, t) {
            ...
            if (r) {
              ...
              return (
                '@' === r[2]
                  ? ((e = rr(this.options.mangle ? t(r[1]) : r[1])), (n = 'mailto:' + e))
                  : ((e = rr(r[1])), (n = e)),
                {
                  type: 'link',
                  raw: r[0],
          ...
          url(e, t) {
            ...
            if ((r = this.rules.inline.url.exec(e))) {
              let e, n;
              if ('@' === r[2]) (e = rr(this.options.mangle ? t(r[0]) : r[0])), (n = 'mailto:' + e);
              else {
                let t;
                do {
                  (t = r[0]), (r[0] = this.rules.inline._backpedal.exec(r[0])[0]);
                } while (t !== r[0]);
                (e = rr(r[0])), (n = 'www.' === r[1] ? 'http://' + e : e);
              }
              return {
                type: 'link',
                raw: r[0],
        ...
        (kr.def = sr(kr.def).replace('label', kr._label).replace('title', kr._title).getRegex()),
          (kr.bullet = /(?:[*+-]|\d{1,9}[.)])/),
          (kr.listItemStart = sr(/^( *)(bull) */)
            .replace('bull', kr.bullet)
            .getRegex()),
          (kr.list = sr(kr.list)
          ...
          (kr.paragraph = sr(kr._paragraph)
            ...
            .replace('tag', kr._tag)
            .getRegex()),
          (kr.blockquote = sr(kr.blockquote).replace('paragraph', kr.paragraph).getRegex()),
          (kr.normal = fr({}, kr)),
          (kr.gfm = fr({}, kr.normal, {
            table:
              '^ *([^\\n ].*\\|.*)\\n {0,3}(?:\\| *)?(:?-+:? *(?:\\| *:?-+:? *)*)(?:\\| *)?(?:\\n((?:(?! *\\n|hr|heading|blockquote|code|fences|list|html).*(?:\\n|$))*)\\n*|$)',
          })),
          (kr.gfm.table = sr(kr.gfm.table)
            .replace('hr', kr.hr)
            .replace('heading', ' {0,3}#{1,6} ')
            .replace('blockquote', ' {0,3}>')
            .replace('code', ' {4}[^\\n]')
            ...
            .replace('tag', kr._tag)
            .getRegex()),
          (kr.gfm.paragraph = sr(kr._paragraph)
            .replace('hr', kr.hr)
            .replace('heading', ' {0,3}#{1,6} ')
            .replace('|lheading', '')
            .replace('table', kr.gfm.table)
            .replace('blockquote', ' {0,3}>')
            .replace('fences', ' {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n')
            .replace('list', ' {0,3}(?:[*+-]|1[.)]) ')
            .replace('html', '</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)')
          ...
          (kr.pedantic = fr({}, kr.normal, {
            ...
            heading: /^(#{1,6})(.*)(?:\n+|$)/,
            fences: mr,
            paragraph: sr(kr.normal._paragraph)
              .replace('hr', kr.hr)
              .replace('heading', ' *#{1,6} *[^\n]')
        ...
        (Or._punctuation = '!"#$%&\'()+\\-.,/:;<=>?@\\[\\]`^{|}~'),
          (Or.punctuation = sr(Or.punctuation)
            .replace(/punctuation/g, Or._punctuation)
            .getRegex()),
          (Or.blockSkip = /\[[^\]]*?\]\([^\)]*?\)|`[^`]*?`|<[^>]*?>/g),
          (Or.escapedEmSt = /\\\*|\\_/g),
          (Or._comment = sr(kr._comment).replace('(?:--\x3e|$)', '--\x3e').getRegex()),
          (Or.emStrong.lDelim = sr(Or.emStrong.lDelim)
            .replace(/punct/g, Or._punctuation)
            .getRegex()),
          (Or.emStrong.rDelimAst = sr(Or.emStrong.rDelimAst, 'g')
            .replace(/punct/g, Or._punctuation)
            .getRegex()),
          (Or.emStrong.rDelimUnd = sr(Or.emStrong.rDelimUnd, 'g')
            .replace(/punct/g, Or._punctuation)
            .getRegex()),
          (Or._escapes = /\\([!"#$%&'()*+,\-./:;<=>?@\[\]\\^_`{|}~])/g),
          (Or._scheme = /[a-zA-Z][a-zA-Z0-9+.-]{1,31}/),
          (Or._email =
            /[a-zA-Z0-9.!#$%&'*+/=?^_`{|}~-]+(@)[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?(?:\.[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?)+(?![-_])/),
          (Or.autolink = sr(Or.autolink)
            .replace('scheme', Or._scheme)
            .replace('email', Or._email)
            .getRegex()),
          (Or._attribute =
            /\s+[a-zA-Z:_][\w.:-]*(?:\s*=\s*"[^"]*"|\s*=\s*'[^']*'|\s*=\s*[^\s"'=<>`]+)?/),
          (Or.tag = sr(Or.tag)
            .replace('comment', Or._comment)
            .replace('attribute', Or._attribute)
            .getRegex()),
          (Or._label = /(?:\[(?:\\.|[^\[\]\\])*\]|\\.|`[^`]*`|[^\[\]\\`])*?/),
          (Or._href = /<(?:\\.|[^\n<>\\])+>|[^\s\x00-\x1f]*/),
          (Or._title = /"(?:\\"?|[^"\\])*"|'(?:\\'?|[^'\\])*'|\((?:\\\)?|[^)\\])*\)/),
          (Or.link = sr(Or.link)
            .replace('label', Or._label)
            .replace('href', Or._href)
            .replace('title', Or._title)
            .getRegex()),
          (Or.reflink = sr(Or.reflink)
            .replace('label', Or._label)
            .replace('ref', kr._label)
            .getRegex()),
          (Or.nolink = sr(Or.nolink).replace('ref', kr._label).getRegex()),
          (Or.reflinkSearch = sr(Or.reflinkSearch, 'g')
            .replace('reflink', Or.reflink)
            .replace('nolink', Or.nolink)
            .getRegex()),
          (Or.normal = fr({}, Or)),
          (Or.pedantic = fr({}, Or.normal, {
            strong: {
              start: /^__|\*\*/,
          ...
          (Or.gfm = fr({}, Or.normal, {
            escape: sr(Or.escape).replace('])', '~|])').getRegex(),
            _extended_email:
          ...
          (Or.gfm.url = sr(Or.gfm.url, 'i').replace('email', Or.gfm._extended_email).getRegex()),
          (Or.breaks = fr({}, Or.gfm, {
            br: sr(Or.br).replace('{2,}', '*').getRegex(),
            text: sr(Or.gfm.text)
              .replace('\\b_', '\\b_| {2,}\\n')
              .replace(/\{2,\}/g, '*')
              .getRegex(),
        ...
        class $r {
          constructor(e) {
            ...
            const t = { block: kr.normal, inline: Or.normal };
            this.options.pedantic
              ? ((t.block = kr.pedantic), (t.inline = Or.pedantic))
              : this.options.gfm &&
                ((t.block = kr.gfm),
                this.options.breaks ? (t.inline = Or.breaks) : (t.inline = Or.gfm)),
              (this.tokenizer.rules = t);
          }
          static get rules() {
            return { block: kr, inline: Or };
          }
          static lex(e, t) {
          ...
          inlineTokens(e, t = []) {
            ...
            for (; e; )
              if (
                ...
                if ((r = this.tokenizer.escape(e))) (e = e.substring(r.raw.length)), t.push(r);
                ...
                else if ((r = this.tokenizer.autolink(e, Sr)))
                  (e = e.substring(r.raw.length)), t.push(r);
                else if (this.state.inLink || !(r = this.tokenizer.url(e, Sr))) {
                  ...
                  if ((r = this.tokenizer.inlineText(o, Er)))
                    (e = e.substring(r.raw.length)),
        ...
        class Rr {
          ...
          link(e, t, r) {
            if (null === (e = cr(this.options.sanitize, this.options.baseUrl, e))) return r;
            let n = '<a href="' + rr(e) + '"';
        ...
        class Ar {
          constructor(e) {
            (this.options = e || Yt),
              (this.options.renderer = this.options.renderer || new Rr()),
              (this.renderer = this.options.renderer),
              (this.renderer.options = this.options),
              (this.textRenderer = new jr()),
              (this.slugger = new Cr());
          }
          static parse(e, t) {
                ...
                switch (u.type) {
                  ...
                  case 'heading':
                    w += this.renderer.heading(
                      ...
                      u.depth,
                      or(this.parseInline(u.tokens, this.textRenderer)),
                      this.slugger,
                    );
                    continue;
                  case 'code':
        ...
        function Pr(e, t, r) {
          ...
          if (
            ...
            const i = function (e) {
              ...
              if (!e)
                try {
                  t.walkTokens && Pr.walkTokens(o, t.walkTokens), (i = Ar.parse(o, t));
                } catch (t) {
                  e = t;
                }
          ...
          try {
            const r = $r.lex(e, t);
            return t.walkTokens && Pr.walkTokens(r, t.walkTokens), Ar.parse(r, t);
          } catch (e) {
            if (
              ((e.message += '\nPlease report this to https://github.com/markedjs/marked.'),
              t.silent)
            )
              return '<p>An error occurred:</p><pre>' + rr(e.message + '', !0) + '</pre>';
            throw e;
          }
        }
        (Pr.options = Pr.setOptions =
          function (e) {
            var t;
            return fr(Pr.defaults, e), (t = Pr.defaults), (Yt = t), Pr;
          }),
          (Pr.getDefaults = function () {
            return {
              baseUrl: null,
              breaks: !1,
              extensions: null,
          ...
          (Pr.use = function (...e) {
            const t = fr({}, ...e),
              r = Pr.defaults.extensions || { renderers: {}, childTokens: {} };
            let n;
            e.forEach(e => {
              if (
                (e.extensions &&
                ...
                const r = Pr.defaults.renderer || new Rr();
              ...
              if (e.tokenizer) {
                const r = Pr.defaults.tokenizer || new wr();
              ...
              if (e.walkTokens) {
                const r = Pr.defaults.walkTokens;
                t.walkTokens = function (t) {
                  e.walkTokens.call(this, t), r && r.call(this, t);
                };
              }
              n && (t.extensions = r), Pr.setOptions(t);
            });
          }),
          (Pr.walkTokens = function (e, t) {
            for (const r of e)
              switch ((t.call(Pr, r), r.type)) {
                case 'table':
                  for (const e of r.header) Pr.walkTokens(e.tokens, t);
                  for (const e of r.rows) for (const r of e) Pr.walkTokens(r.tokens, t);
                  break;
                case 'list':
                  Pr.walkTokens(r.items, t);
                  break;
                default:
                  Pr.defaults.extensions &&
                  Pr.defaults.extensions.childTokens &&
                  Pr.defaults.extensions.childTokens[r.type]
                    ? Pr.defaults.extensions.childTokens[r.type].forEach(function (e) {
                        Pr.walkTokens(r[e], t);
                      })
                    : r.tokens && Pr.walkTokens(r.tokens, t);
              }
          }),
          (Pr.parseInline = function (e, t) {
            if (null == e)
            ...
            br((t = fr({}, Pr.defaults, t || {})));
            try {
              const r = $r.lexInline(e, t);
              return t.walkTokens && Pr.walkTokens(r, t.walkTokens), Ar.parseInline(r, t);
            } catch (e) {
              if (
                ((e.message += '\nPlease report this to https://github.com/markedjs/marked.'),
                t.silent)
        ...
        var Ir = Object.defineProperty,
          ...
          Mr = (e, t, r) =>
            t in e
              ...
              : (e[t] = r),
          Nr = (e, t) => {
            for (var r in t || (t = {})) Dr.call(t, r) && Mr(e, r, t[r]);
            if (Lr) for (var r of Lr(t)) zr.call(t, r) && Mr(e, r, t[r]);
            return e;
          };
        const qr = new Pr.Renderer();
        Pr.setOptions({ renderer: qr, highlight: (e, t) => $t(e, t) });
        const Fr = '^ {0,3}\x3c!-- ReDoc-Inject:\\s+?<({component}).*?/?>\\s+?--\x3e\\s*$',
          Br =
        ...
        class Wr {
          constructor(e, t) {
            (this.options = e),
              ...
              (this.parentId = t),
              (this.parser = new Pr.Parser()),
              (this.headingEnhanceRenderer = new Pr.Renderer()),
          ...
          static containsComponent(e, t) {
            return new RegExp(Qr.replace(/{component}/g, t), 'gmi').test(e);
          }
          ...
          saveHeading(e, t, r = this.headings, n) {
            e = P(e);
            const o = {
              id: n ? `${n}/${O(e)}` : `${this.parentId || 'section'}/${O(e)}`,
              name: e,
              level: t,
              items: [],
            };
          ...
          renderMdWithComponents(e) {
            ...
            const r = Object.keys(t).join('|'),
              n = new RegExp(Qr.replace(/{component}/g, r), 'mig'),
              o = [],
              i = [];
            let s = n.exec(e),
              a = 0;
            for (; s; ) {
              ...
              r &&
                i.push({
                  ...
                  props: ((l = Nr(Nr({}, Vr(p)), r.props)), (c = { children: u }), Tr(l, _r(c))),
                }),
                (s = n.exec(e));
            }
            var l, c;
        ...
        class Hr {
          ...
          getDownloadLink() {
            ...
            if (l && window.Blob && window.URL && window.URL.createObjectURL) {
          ...
          constructor(e, t) {
            ...
            this.schemes = Object.keys(e || {})
              .map(n => {
                ...
                return (
                  (a = ((e, t) => {
                    for (var r in t || (t = {})) Xr.call(t, r) && en(e, r, t[r]);
                    if (Gr) for (var r of Gr(t)) Kr.call(t, r) && en(e, r, t[r]);
                    return e;
                  })({}, o)),
                  Yr(a, Zr({ id: n, sectionId: n, displayName: s, scopes: i }))
                );
                var a;
              })
              .filter(e => void 0 !== e);
        ...
        var rn = Object.defineProperty,
          ...
          pn = (e, t, r) =>
            t in e
              ...
              : (e[t] = r),
          un = (e, t) => {
            for (var r in t || (t = {})) ln.call(t, r) && pn(e, r, t[r]);
            if (an) for (var r of an(t)) cn.call(t, r) && pn(e, r, t[r]);
            return e;
          },
          dn = (e, t, r, n) => {
            for (var o, i = n > 1 ? void 0 : n ? on(t, r) : t, s = e.length - 1; s >= 0; s--)
              (o = e[s]) && (i = (n ? o(t, r, i) : o(i)) || i);
            return n && i && rn(t, r, i), i;
          };
        class hn {
          constructor(e, t, r, n, o) {
            (this.expanded = !1),
              (this.operations = []),
              (0, fe.makeObservable)(this),
              (this.name = t);
            const { resolved: i } = e.deref(r);
            for (const r of Object.keys(i)) {
              const l = i[r],
                c = Object.keys(l).filter(Fe);
              for (const i of c) {
                const c = l[i],
                  p = new bo(
                    e,
        ...
        dn([fe.observable], hn.prototype, 'expanded', 2),
          dn([fe.action], hn.prototype, 'toggle', 1);
        var mn = Object.defineProperty,
          ...
          vn = (e, t, r) =>
            t in e
              ...
              : (e[t] = r),
          wn = (e, t) => {
            for (var r in t || (t = {})) bn.call(t, r) && vn(e, r, t[r]);
            if (yn) for (var r of yn(t)) xn.call(t, r) && vn(e, r, t[r]);
            return e;
          },
          kn = (e, t) => fn(e, gn(t)),
          On = (e, t) => {
            ...
            if (null != e && yn)
              for (var n of yn(e)) t.indexOf(n) < 0 && xn.call(e, n) && (r[n] = e[n]);
            return r;
          };
        function En(e, t) {
        ...
        class $n {
          constructor(e, t, r = new H({})) {
            ...
            const n = l ? window.location.href : '';
          ...
          deref(e, t = [], r = !1) {
            ...
            return { resolved: e, refsStack: Sn(t, n) };
          }
          mergeRefs(e, t, r) {
            const n = e,
              { $ref: o } = n,
            ...
            if (
              ...
              return {
                allOf: [
                  ...
                  t,
                  On(e, ['description', 'title', 'readOnly', 'writeOnly']),
                ],
              };
            }
            return wn(wn({}, t), i);
          ...
          mergeAllOf(e, t, r) {
            ...
            let o = kn(wn({}, e), { 'x-parentRefs': [], allOf: void 0, title: e.title || ot(t) });
            void 0 !== o.properties &&
              'object' == typeof o.properties &&
              (o.properties = wn({}, o.properties)),
              void 0 !== o.items && 'object' == typeof o.items && (o.items = wn({}, o.items));
                ...
                .map(e => {
                  ...
                  if (!a['x-circular-ref'] || !a.allOf)
                    return (
                      ...
                      { $ref: s, refsStack: En(i, s), schema: a }
                    );
                })
                .filter(e => void 0 !== e),
            );
            for (const { schema: e, refsStack: r } of i) {
              ...
              if (
                ...
                for (const e in l) {
                  const i = Sn(r, null == (n = l[e]) ? void 0 : n['x-refsStack']);
                  if (o.properties[e]) {
                    if (!y) {
                      const r = this.mergeAllOf(
                        {
                          allOf: [o.properties[e], kn(wn({}, l[e]), { 'x-refsStack': i })],
                          'x-refsStack': i,
                        },
                        t + '/properties/' + e,
                        i,
                  ...
                  } else o.properties[e] = kn(wn({}, l[e]), { 'x-refsStack': i });
                }
              }
              if (void 0 !== c && !y) {
        ...
        var Rn = Object.defineProperty,
          ...
          Ln = (e, t) => {
            ...
            if (Pn) for (var r of Pn(t)) Tn.call(t, r) && _n(e, r, t[r]);
            return e;
          },
          Dn = (e, t) => jn(e, An(t)),
          zn = (e, t, r, n) => {
        ...
        const Mn = class {
          constructor(e, t, r, n, o = !1, i = []) {
            ...
            (this.refsStack = En(a, this.pointer)),
              (this.rawSchema = s),
              (this.schema = e.mergeAllOf(this.rawSchema, this.pointer, this.refsStack)),
              this.init(e, o),
              n.showExtensions && (this.extensions = wt(this.schema, n.showExtensions));
          }
          activateOneOf(e) {
            this.activeOneOf = e;
          }
          hasType(e) {
            return this.type === e || (I(this.type) && this.type.includes(e));
          }
          init(e, t) {
            var r, n, o, i, s, a, l, c;
            const p = this.schema;
            if (
              ...
              (this.title = p.title || (nt(this.pointer) && Se.baseName(this.pointer)) || ''),
              (this.description = p.description || ''),
              (this.type = p.type || Ue(p)),
              ...
              (this.constraints = at(p)),
              (this.displayFormat = this.format),
              (this.isPrimitive = We(p, this.type)),
              ...
              (p.nullable || p['x-nullable']) &&
                (I(this.type) && !this.type.some(e => null === e || 'null' === e)
                  ? (this.type = [...this.type, 'null'])
                  : I(this.type) ||
                    (null === this.type && 'null' === this.type) ||
                    (this.type = [this.type, 'null'])),
              (this.displayType = I(this.type)
                ? this.type.map(e => (null === e ? 'null' : e)).join(' or ')
                : this.type),
              !this.isCircular)
            )
              if ((p.if && p.then) || (p.if && p.else)) this.initConditionalOperators(p, e);
              else if (t || void 0 === Fn(p)) {
                if (
                  (t && I(p.oneOf) && p.oneOf.find(e => e.$ref === this.pointer) && delete p.oneOf,
                  void 0 !== p.oneOf)
                )
                  return (
                ...
                if (this.hasType('object'))
                  this.fields = qn(e, p, this.pointer, this.options, this.refsStack);
                else if (
                  this.hasType('array') &&
                  (I(p.items) || I(p.prefixItems)
                    ? (this.fields = qn(e, p, this.pointer, this.options, this.refsStack))
                    : p.items &&
                      (this.items = new Mn(
                        e,
                  ...
                  (this.typePrefix =
                    (null == (o = this.items) ? void 0 : o.typePrefix) || '' + L('arrayOf')),
            ...
            if (
              ((this.oneOf = e.map((e, r) => {
                ...
                return new Mn(
                  ...
                  Dn(Ln({}, i), {
                    title: s,
                    allOf: [Dn(Ln({}, this.schema), { oneOf: void 0, anyOf: void 0 })],
          ...
          initDiscriminator(e, t) {
            ...
            for (const e in o) {
              const t = o[e];
              I(s[t]) ? s[t].push(e) : (s[t] = [e]);
            }
            const a = Ln(i ? {} : Ln({}, n), s);
            let l = [];
            for (const e of Object.keys(a)) {
              const t = a[e];
              if (I(t)) for (const r of t) l.push({ $ref: e, name: r });
            ...
            0 !== c.length &&
              ...
              (this.oneOf = l.map(({ $ref: e, name: r }) => {
                const n = new Mn(t, { $ref: e }, e, this.options, !0, this.refsStack.slice(0, -1));
                return (n.title = r), n;
              }));
          }
          initConditionalOperators(e, t) {
            const r = e,
              ...
              s = ((e, t) => {
                ...
                if (null != e && Pn)
                  for (var n of Pn(e)) t.indexOf(n) < 0 && Tn.call(e, n) && (r[n] = e[n]);
                return r;
              })(r, ['if', 'else', 'then']),
              a = [
                {
        ...
        function qn(e, t, r, n, o) {
          ...
          let p = Object.keys(i || []).map(s => {
            ...
            return new Jn(
              e,
              {
                ...
                required: l,
                schema: Dn(Ln({}, a), { default: void 0 === a.default && c ? c[s] : a.default }),
              },
              r + '/properties/' + s,
              n,
              o,
          ...
          return (
            n.sortPropsAlphabetically && (p = ct(p, 'name')),
            n.requiredPropsFirst && (p = lt(p, n.sortPropsAlphabetically ? void 0 : t.required)),
            p.push(
              ...Object.keys(s).map(t => {
                let i = s[t];
                return (
            ...
            p.push(
              ...(function ({
                ...
                return T(t)
                  ? t
                    ? [new Jn(e, { name: `[${r}...]`, schema: {} }, `${n}/additionalItems`, o, i)]
                    : []
                  : I(t)
                  ? [
                      ...t.map(
                  ...
                  : w(t)
                  ? [new Jn(e, { name: `[${r}...]`, schema: t }, `${n}/additionalItems`, o, i)]
                  : [];
              })({
                parser: e,
                schema: l,
        ...
        zn([fe.observable], Nn.prototype, 'activeOneOf', 2),
          zn([fe.action], Nn.prototype, 'activateOneOf', 1);
        const Bn = {};
        class Qn {
          constructor(e, t, r, n) {
            this.mime = r;
            ...
            (this.value = o.value),
              ...
              He(r) &&
                ...
                (this.value = Ge(this.value, n));
          }
          getExternalValue(e) {
            return this.externalValueUrl
              ? (this.externalValueUrl in Bn ||
                  (Bn[this.externalValueUrl] = fetch(this.externalValueUrl).then(t =>
                    t.text().then(r => {
        ...
        var Un = Object.defineProperty,
          ...
          Vn = (e, t, r, n) => {
            for (var o, i = n > 1 ? void 0 : n ? Wn(t, r) : t, s = e.length - 1; s >= 0; s--)
              (o = e[s]) && (i = (n ? o(t, r, i) : o(i)) || i);
            return n && i && Un(t, r, i), i;
          };
        const Hn = {
        ...
        class Jn {
          constructor(e, t, r, n, o) {
            var i, s, a, l, c;
            (this.expanded = void 0), (0, fe.makeObservable)(this);
            ...
            if (
              ...
              this.examples = I(t) ? t : f(t, (t, r) => new Qn(e, t, r, p.encoding));
            }
            d
              ...
              : this.in &&
                (this.style =
                  null != (s = null == (i = Hn[this.in]) ? void 0 : i.style) ? s : 'form'),
              void 0 === p.explode && this.in
                ? (this.explode = null == (l = null == (a = Hn[this.in]) ? void 0 : a.explode) || l)
                : (this.explode = !!p.explode),
              (this.deprecated = void 0 === p.deprecated ? !!this.schema.deprecated : p.deprecated),
              n.showExtensions && (this.extensions = wt(p, n.showExtensions)),
              (this.const =
        ...
        Vn([fe.observable], Jn.prototype, 'expanded', 2),
          Vn([fe.action], Jn.prototype, 'toggle', 1),
          Vn([fe.action], Jn.prototype, 'collapse', 1),
          Vn([fe.action], Jn.prototype, 'expand', 1);
        var Yn = require('openapi-sampler');
        class Zn {
          constructor(e, t, r, n, o) {
            (this.name = t),
              ...
              void 0 !== n.examples
                ? (this.examples = f(n.examples, r => new Qn(e, r, t, n.encoding)))
                : void 0 !== n.example
                ? (this.examples = {
                    default: new Qn(e, { value: e.deref(n.example).resolved }, t, n.encoding),
                  })
                : Ve(t) && this.generateExample(e, n);
          }
          generateExample(e, t) {
            const r = {
            ...
            if (this.schema && this.schema.oneOf) {
              ...
              for (const n of this.schema.oneOf) {
                const o = Yn.sample(n.rawSchema, r, e.spec);
                this.schema.discriminatorProp &&
                  'object' == typeof o &&
                  o &&
                  (o[this.schema.discriminatorProp] = n.title),
                  (this.examples[n.title] = new Qn(e, { value: o }, this.name, t.encoding));
              }
            } else
              this.schema &&
                (this.examples = {
                  default: new Qn(
                    e,
                    { value: Yn.sample(t.schema, r, e.spec) },
                    this.name,
                    t.encoding,
                  ),
                });
        ...
        var Gn = Object.defineProperty,
          ...
          Kn = (e, t, r, n) => {
            for (var o, i = n > 1 ? void 0 : n ? Xn(t, r) : t, s = e.length - 1; s >= 0; s--)
              (o = e[s]) && (i = (n ? o(t, r, i) : o(i)) || i);
        ...
        class eo {
          constructor(e, t, r, n) {
            (this.isRequestType = r),
              ...
              (0, fe.makeObservable)(this),
              n.unstable_ignoreMimeParameters && (t = ut(t)),
              (this.mediaTypes = Object.keys(t).map(o => {
                const i = t[o];
                return new Zn(e, o, r, i, n);
              }));
          }
          activate(e) {
        ...
        Kn([fe.observable], eo.prototype, 'activeMimeIdx', 2),
          Kn([fe.action], eo.prototype, 'activate', 1),
          Kn([fe.computed], eo.prototype, 'active', 1);
        class to {
          constructor({ parser: e, infoOrRef: t, options: r, isEvent: n }) {
            ...
            const s = Ot(i);
            void 0 !== s && (this.content = new eo(e, s, o, r));
          }
        }
        var ro = Object.defineProperty,
          ...
          co = (e, t, r) =>
            t in e
              ...
              : (e[t] = r),
          po = (e, t, r, n) => {
            for (var o, i = n > 1 ? void 0 : n ? oo(t, r) : t, s = e.length - 1; s >= 0; s--)
              (o = e[s]) && (i = (n ? o(t, r, i) : o(i)) || i);
        ...
        class uo {
          constructor({
            ...
            (this.code = t),
              void 0 !== s.content && (this.content = new eo(e, s.content, i, o)),
              void 0 !== s['x-summary']
            ...
            void 0 !== a &&
              (this.headers = Object.keys(a).map(t => {
                ...
                return new Jn(
                  e,
                  ((n = ((e, t) => {
                    for (var r in t || (t = {})) ao.call(t, r) && co(e, r, t[r]);
                    if (so) for (var r of so(t)) lo.call(t, r) && co(e, r, t[r]);
                    return e;
                  })({}, r)),
                  no(n, io({ name: t }))),
                  '',
              ...
              o.showExtensions && (this.extensions = wt(s, o.showExtensions));
          }
          toggle() {
            this.expanded = !this.expanded;
          }
        }
        po([fe.observable], uo.prototype, 'expanded', 2),
          po([fe.action], uo.prototype, 'toggle', 1);
        var ho = Object.defineProperty,
          mo = Object.getOwnPropertyDescriptor,
          fo = (e, t, r, n) => {
            for (var o, i = n > 1 ? void 0 : n ? mo(t, r) : t, s = e.length - 1; s >= 0; s--)
              (o = e[s]) && (i = (n ? o(t, r, i) : o(i)) || i);
            return n && i && ho(t, r, i), i;
          };
        function go(e) {
        ...
        class bo {
          constructor(e, t, r, n, o = !1) {
            (this.parser = e),
              ...
              (this.name = Be(t)),
              (this.sidebarLabel =
                n.sideNavStyle === D.IdOnly
                  ? this.operationId || this.path
                  : n.sideNavStyle === D.PathOnly
                  ? this.path
                  : this.name),
              this.isCallback
                ? ((this.security = (t.security || []).map(t => new tn(t, e))),
                ...
                : ((this.operationHash = t.operationId && 'operation/' + t.operationId),
                  (this.id =
                    void 0 !== t.operationId
                      ...
                      ? r.id + this.pointer
                      : this.pointer),
                  (this.security = (t.security || e.spec.security || []).map(t => new tn(t, e))),
                  (this.servers = ht(
                    e.specUrl,
                    t.servers || t.pathServers || e.spec.servers || [],
                  ))),
              n.showExtensions && (this.extensions = wt(t, n.showExtensions));
          }
          activate() {
            this.active = !0;
          }
          ...
          get parameters() {
            ...
            ).map(e => new Jn(this.parser, e, this.pointer, this.options));
          ...
          get responses() {
            ...
            return Object.keys(this.operationSpec.responses || [])
              .filter(t => 'default' === t || ('success' === Ne(t) && (e = !0), Me(t)))
              .map(
                t =>
                  new uo({
                    parser: this.parser,
          ...
          get callbacks() {
            return Object.keys(this.operationSpec.callbacks || []).map(
              e =>
                new hn(this.parser, e, this.operationSpec.callbacks[e], this.pointer, this.options),
            );
          }
        }
        fo([fe.observable], bo.prototype, 'ready', 2),
          fo([fe.observable], bo.prototype, 'active', 2),
          fo([fe.observable], bo.prototype, 'expanded', 2),
          fo([fe.action], bo.prototype, 'activate', 1),
          fo([fe.action], bo.prototype, 'deactivate', 1),
          fo([fe.action], bo.prototype, 'toggle', 1),
          fo([qt], bo.prototype, 'requestBody', 1),
          fo([qt], bo.prototype, 'codeSamples', 1),
          fo([qt], bo.prototype, 'parameters', 1),
          fo([qt], bo.prototype, 'responses', 1),
          fo([qt], bo.prototype, 'callbacks', 1);
        var xo = Object.defineProperty,
          ...
          $o = (e, t) => {
            ...
            if (ko) for (var r of ko(t)) Eo.call(t, r) && So(e, r, t[r]);
            return e;
          };
        class Ro {
          constructor(e, t, r) {
          ...
          initWebhooks(e, t, r) {
            for (const o of Object.keys(t)) {
              ...
              for (const t of s) {
                ...
                if (!o) continue;
                const s = new bo(e, ((n = $o({}, o)), vo(n, wo({ httpVerb: t }))), void 0, r, !1);
        ...
        class Co {
          constructor(e) {
            ...
            this.schemes = Object.keys(t).map(r => new jo(e, r, t[r]));
          }
        }
        var Ao = Object.defineProperty,
          ...
          Lo = (e, t) => {
            ...
            if (Po) for (var r of Po(t)) To.call(t, r) && _o(e, r, t[r]);
            return e;
          };
        class Do {
          constructor(e, t, r) {
            var n, o, i;
            (this.options = r),
              (this.parser = new $n(e, t, r)),
              (this.info = new Hr(this.parser, this.options)),
              (this.externalDocs = this.parser.spec.externalDocs),
              (this.contentItems = Go.buildStructure(this.parser, this.options)),
              (this.securitySchemes = new Co(this.parser));
            const s = Lo(
              Lo(
                {},
            ...
            this.webhooks = new Ro(this.parser, r, s);
          }
        }
        ...
        class qo {
          constructor(e, t, r) {
            ...
            n &&
              n.length &&
              (this.description = Wr.getTextBeforeHading(this.description, n[0].name)),
              (this.parent = r),
              (this.externalDocs = t.externalDocs),
        ...
        No([fe.observable], qo.prototype, 'active', 2),
          No([fe.observable], qo.prototype, 'expanded', 2),
          No([fe.action], qo.prototype, 'activate', 1),
          No([fe.action], qo.prototype, 'expand', 1),
          No([fe.action], qo.prototype, 'collapse', 1),
          No([fe.action], qo.prototype, 'deactivate', 1);
        var Fo = Object.defineProperty,
          ...
          Ho = (e, t, r) =>
            t in e
              ...
              : (e[t] = r),
          Jo = (e, t) => {
            for (var r in t || (t = {})) Wo.call(t, r) && Ho(e, r, t[r]);
            if (Uo) for (var r of Uo(t)) Vo.call(t, r) && Ho(e, r, t[r]);
            return e;
          },
          Yo = (e, t) => Bo(e, Qo(t));
        const Zo = 0;
        class Go {
          static buildStructure(e, t) {
            const r = e.spec,
              n = [],
              o = Go.getTagsWithOperations(e, r);
            return (
              n.push(...Go.addMarkdownItems(r.info.description || '', void 0, 1, t)),
              r['x-tagGroups'] && r['x-tagGroups'].length > 0
                ? n.push(...Go.getTagGroupsItems(e, void 0, r['x-tagGroups'], o, t))
                : n.push(...Go.getTagsItems(e, o, void 0, void 0, t)),
              n
            );
          }
          static addMarkdownItems(e, t, r, n) {
            const o = new Wr(n, null == t ? void 0 : t.id).extractHeadings(e || '');
            o.length &&
              t &&
              t.description &&
              (t.description = Wr.getTextBeforeHading(t.description, o[0].name));
            const i = (e, t, r = 1) =>
              t.map(t => {
                const n = new qo('section', t, e);
          ...
          static getTagGroupsItems(e, t, r, n, o) {
            const i = [];
            for (const s of r) {
              const r = new qo('group', s, t);
              (r.depth = Zo), (r.items = Go.getTagsItems(e, n, r, s, o)), i.push(r);
            }
            return i;
          }
          static getTagsItems(e, t, r, n, o) {
            ...
            for (const t of s) {
              if (!t) continue;
              const n = new qo('tag', t, r);
              if (((n.depth = Zo + 1), '' !== t.name))
                (n.items = [
                  ...Go.addMarkdownItems(t.description || '', n, n.depth + 1, o),
            ...
            return o.sortTagsAlphabetically && a.sort(Ft('name')), a;
          }
          static getOperationsItems(e, t, r, n, o) {
            if (0 === r.operations.length) return [];
            const i = [];
            for (const s of r.operations) {
              const r = new bo(e, s, t, o);
              (r.depth = n), i.push(r);
            }
            return o.sortOperationsAlphabetically && i.sort(Ft('name')), i;
          }
          static getTagsWithOperations(e, t) {
            const r = {},
              n = t['x-webhooks'] || t.webhooks;
            for (const e of t.tags || []) r[e.name] = Yo(Jo({}, e), { operations: [] });
            function o(e, t, n) {
              for (const i of Object.keys(t)) {
                const s = t[i],
                  a = Object.keys(s).filter(Fe);
                for (const t of a) {
                  const a = s[t];
                  if (s.$ref) {
        ...
        var Xo = Object.defineProperty,
          ...
          ei = (e, t, r, n) => {
            for (var o, i = n > 1 ? void 0 : n ? Ko(t, r) : t, s = e.length - 1; s >= 0; s--)
              (o = e[s]) && (i = (n ? o(t, r, i) : o(i)) || i);
            return n && i && Xo(t, r, i), i;
          };
        const ti = 'data-section-id';
        class ri {
          constructor(e, t, r) {
            (this.scroll = t),
              (this.history = r),
              ...
              (this.updateOnHistory = (e = this.history.currentId) => {
                ...
                (t = this.flatItems.find(t => t.id === e)),
                  t
                    ...
                    : (e.startsWith(yt) &&
                        ((t = this.flatItems.find(e => yt.startsWith(e.id))),
                        this.activateAndScroll(t, !1)),
                      this.scroll.scrollIntoViewBySelector(`[${ti}="${A(e)}"]`));
              }),
              (this.getItemById = e => this.flatItems.find(t => t.id === e)),
              (0, fe.makeObservable)(this),
              (this.items = e.contentItems),
              (this.flatItems = g(this.items || [], 'items')),
              this.flatItems.forEach((e, t) => (e.absoluteIdx = t)),
              this.subscribe();
          }
          static updateOnHistory(e = Vt.currentId, t) {
            e && t.scrollIntoViewBySelector(`[${ti}="${A(e)}"]`);
          }
          subscribe() {
          ...
          getElementAt(e) {
            ...
            return (t && c(`[${ti}="${A(t.id)}"]`)) || null;
          }
          getElementAtOrFirstChild(e) {
            let t = this.flatItems[e];
            return (
              t && 'group' === t.type && (t = t.items[0]), (t && c(`[${ti}="${A(t.id)}"]`)) || null
            );
          }
          get activeItem() {
        ...
        ei([fe.observable], ri.prototype, 'activeItemIdx', 2),
          ei([fe.observable], ri.prototype, 'sideBarOpened', 2),
          ei([fe.action], ri.prototype, 'toggleSidebar', 1),
          ei([fe.action], ri.prototype, 'closeSidebar', 1),
          ei([fe.action], ri.prototype, 'activate', 1),
          ei([fe.action.bound], ri.prototype, 'activateAndScroll', 1);
        ...
        class si {
          constructor(e) {
            (this.options = e),
              (this._prevOffsetY = 0),
              (this._scrollParent = l ? window : void 0),
              (this._emiter = new ke()),
              this.bind();
          }
          bind() {
          ...
          dispose() {
            this._scrollParent &&
              ...
              this._emiter.removeAllListeners(ii);
          }
          scrollY() {
          ...
          subscribe(e) {
            const t = this._emiter.addListener(ii, e);
            return () => t.removeListener(ii, e);
          }
          scrollIntoView(e) {
            null !== e &&
              (e.scrollIntoView(),
          ...
          handleScroll() {
            ...
            (this._prevOffsetY = this.scrollY()), this._emiter.emit(ii, e);
          }
        }
        ((e, t, r, n) => {
          for (var o, i = oi(t, r), s = e.length - 1; s >= 0; s--)
            (o = e[s]) && (i = o(t, r, i) || i);
          i && ni(t, r, i);
        })([we.bind, Rt(100)], si.prototype, 'handleScroll');
        class ai {
          constructor() {
...
`,
  ...
  `};
`,
          hi = { 1: '1.85714em', 2: '1.57143em', 3: '1.27em' },
          mi = e => G`
...
`;
        function $i(t) {
          return e.createElement(Si, { to: t.to });
        }
        const Ri = { left: '90deg', right: '-90deg', up: '-180deg', down: '0' },
          ji = re(t =>
            e.createElement(
              'svg',
              {
...
`,
  ...
  line-height: 1.6;
  border-radius: 4px;
  font-weight: ${({ theme: e, type: t }) =>
    'warning' === t ? 'normal' : e.typography.fontWeightBold};
  font-size: 13px;
  + span[type] {
    margin-left: 4px;
  }
...
`;
        ...
        function ls(t) {
          return e.createElement(de.Consumer, null, r =>
            r.nativeScrollbars
              ? e.createElement(
                  'div',
                  {
        ...
        const cs = re(({ className: t, style: r }) =>
            e.createElement(
              'svg',
              {
                className: t,
        ...
        function xs(t) {
          ...
          return 1 === t.options.length
            ...
            : e.createElement(
                n,
                ((e, t) => {
                  for (var r in t || (t = {})) gs.call(t, r) && bs(e, r, t[r]);
                  if (fs) for (var r of fs(t)) ys.call(t, r) && bs(e, r, t[r]);
                  return e;
                })({}, t),
              );
        }
        var vs = require('dompurify');
        const ws = G`
  a {
...
`;
        var Os = Object.defineProperty,
          ...
          Rs = (e, t, r) =>
            t in e
              ? Os(e, t, { enumerable: !0, configurable: !0, writable: !0, value: r })
              : (e[t] = r);
        const js = ks.withComponent('span');
        function Cs(t) {
          const r = t.inline ? js : ks;
          return e.createElement(me, null, n => {
            return e.createElement(
              r,
              ((e, t) => {
                for (var r in t || (t = {})) Ss.call(t, r) && Rs(e, r, t[r]);
                if (Es) for (var r of Es(t)) $s.call(t, r) && Rs(e, r, t[r]);
                return e;
              })(
                {
                  className: 'redoc-markdown ' + (t.className || ''),
                  dangerouslySetInnerHTML: {
                    __html: ((o = n.untrustedSpec), (i = t.html), o ? vs.sanitize(i) : i),
                  },
...
`;
            ...
            return e.createElement(
              ...
              t &&
                e.createElement(
                  Is,
                  null,
                  e.createElement(Ts, null, r),
                  e.createElement(_s, null),
        ...
        class Ms {
          ...
          static copyElement(e) {
            Ms.selectElement(e);
            const t = Ms.copySelected();
            return t && Ms.deselect(), t;
          }
          static copyCustom(e) {
          ...
          return t.children({
            renderCopyButton: () =>
              e.createElement(
                ...
                e.createElement(
                  Ds,
                  { title: Ms.isSupported() ? 'Copied' : 'Not supported in your browser', open: r },
                  'Copy',
                ),
              ),
          });
        ...
        function Vs(e, t) {
          ...
          return (
            null == e
              ? (n += Us('null', 'token keyword'))
              : e && e.constructor === Array
              ? (qs++,
                (n += (function (e, t) {
                  const r = qs > t ? 'collapsed' : '';
                  let n = `<button class="collapser" aria-label="${
                      qs > t + 1 ? 'expand' : 'collapse'
                    }"></button>${Ws(
                      '[',
                  ...
                  for (let s = 0; s < i; s++)
                    (o = !0),
                      ...
                      s < i - 1 && (n += ','),
                      (n += '</div></li>');
                  return (n += `</ul>${Ws(']')}`), o || (n = Ws('[ ]')), n;
                })(e, t)),
                qs--)
              : e && e.constructor === Date
              ? (n += Us('"' + e.toISOString() + '"', 'token string'))
              : 'object' === r
              ? (qs++,
                (n += (function (e, t) {
                  const r = qs > t ? 'collapsed' : '',
                  ...
                  for (let a = 0; a < o; a++) {
                    ...
                    (s = !0),
                      ...
                      (i += '<span class="property token string">"' + Bs(l) + '"</span>: '),
                      (i += Vs(e[l], t)),
                      a < o - 1 && (i += Ws(',')),
                      (i += '</div></li>');
                  }
                  return (i += `</ul>${Ws('}')}`), s || (i = Ws('{ }')), i;
                })(e, t)),
                qs--)
              : 'number' === r
              ? (n += Us(e, 'token number'))
              ...
              ? /^(http|https):\/\/[^\s]+$/.test(e)
                ? (n +=
                    ...
                    '</a>' +
                    Us('"', 'token string'))
                : (n += Us('"' + Qs(e) + '"', 'token string'))
              : 'boolean' === r && (n += Us(e, 'token boolean')),
            n
          );
        }
        const Hs = G`
...
`,
          Ys = re(t => {
            const [r, n] = e.useState(),
              o = ({ renderCopyButton: r }) => {
                ...
                return e.createElement(
                  ...
                  e.createElement(de.Consumer, null, r =>
                    e.createElement(Vi, {
                      className: t.className,
                      ref: e => n(e),
                      dangerouslySetInnerHTML: { __html: Fs(t.data, r.jsonSampleExpandLevel) },
                    }),
                  ),
                );
              },
            ...
            return (
              ...
              e.createElement(Ns, { data: t.data }, o)
            );
          })`
  ${Hs};
`,
          Zs = t => {
            ...
            return e.createElement(Yi, { dangerouslySetInnerHTML: { __html: $t(r, n) } });
          },
          Gs = t => {
            const { source: r, lang: n } = t;
            return e.createElement(Ns, { data: r }, ({ renderCopyButton: t }) =>
              e.createElement(
                Ji,
                null,
                e.createElement(Hi, null, t()),
                e.createElement(Zs, { lang: n, source: r }),
              ),
            );
          };
        function Xs({ value: t, mimeType: r }) {
          return Ve(r)
            ? e.createElement(Ys, { data: t })
            : ('object' == typeof t && (t = JSON.stringify(t, null, 2)),
              e.createElement(Gs, { lang: tt(r), source: t }));
        }
        function Ks({ example: t, mimeType: r }) {
          return void 0 === t.value && t.externalValueUrl
            ? e.createElement(ea, { example: t, mimeType: r })
            : e.createElement(Xs, { value: t.value, mimeType: r });
        }
        function ea({ example: t, mimeType: r }) {
          ...
          return void 0 === n
            ...
            : e.createElement(Xs, { value: n, mimeType: r });
        }
        const ta = re.div`
  padding: 0.9em;
  background-color: ${o.palette.gray.dark2};
        ...
        class sa extends e.Component {
          ...
          render() {
            const { activeIdx: t } = this.state,
              ...
              o = e.createElement(ia, null, 'No sample'),
              i = Object.keys(r);
            ...
            if (i.length > 1) {
              ...
              return e.createElement(
                ...
                e.createElement(
                  na,
                  null,
                  e.createElement(ra, null, 'Example'),
                ...
                e.createElement(
                  'div',
                  null,
                  a && e.createElement(As, { source: a }),
                  e.createElement(Ks, { example: s, mimeType: n }),
                ),
              );
            }
            {
              ...
              return e.createElement(
                aa,
                null,
                t.description && e.createElement(As, { source: t.description }),
                e.createElement(Ks, { example: t, mimeType: n }),
              );
            }
          }
        }
...
`;
        ...
        class Sa extends e.PureComponent {
          constructor() {
          ...
          render() {
            ...
            return e.createElement(
              ...
              e.createElement(
                ...
                r ? L('enumArray') : '',
                ' ',
                1 === t.length ? L('enumSingleValue') : L('enum'),
                ':',
              ),
              ' ',
              s.map((t, r) => {
                const n = o ? String(t) : JSON.stringify(t);
                return e.createElement(e.Fragment, { key: r }, e.createElement(xa, null, n), ' ');
              }),
              a
                ? e.createElement(
                    $a,
...
`,
  ...
  margin: 2px 0;
`;
        class ja extends e.PureComponent {
          render() {
                ...
                r.showExtensions &&
                  Object.keys(t).map(r =>
                    e.createElement(
                      Ra,
                      { key: r },
                      e.createElement(pa, null, ' ', r.substring(2), ': '),
                      ' ',
                      e.createElement(
                        va,
                        null,
        ...
        function Ca({ field: t }) {
          return t.examples
            ? e.createElement(
                e.Fragment,
                null,
                e.createElement(pa, null, ' ', L('examples'), ': '),
                I(t.examples)
                  ? t.examples.map((r, n) => {
                      const o = et(t, r),
                  ...
                  : e.createElement(
                      ...
                      Object.values(t.examples).map((r, n) =>
                        e.createElement(
                          'li',
                          { key: n + r.value },
                          e.createElement(xa, null, et(t, r.value)),
                          ' -',
                          ' ',
          ...
          render() {
            return 0 === this.props.constraints.length
              ...
              : e.createElement(
                  ...
                  null,
                  ' ',
                  this.props.constraints.map(t => e.createElement(wa, { key: t }, ' ', t, ' ')),
                );
          }
        }
        const Ia = e.memo(function ({ value: t, label: r, raw: n }) {
          if (void 0 === t) return null;
          const o = n ? String(t) : JSON.stringify(t);
          return e.createElement(
            'div',
            null,
            e.createElement(pa, null, ' ', r, ' '),
            ' ',
            e.createElement(xa, null, o),
          );
        });
        function Ta(t) {
          const r = t.schema.pattern,
            { hideSchemaPattern: n } = e.useContext(de),
            [o, i] = e.useState(!1),
          ...
          return !r || n
            ...
            : e.createElement(
                e.Fragment,
                null,
                e.createElement(ba, null, o || r.length < 45 ? r : `${r.substr(0, 45)}...`),
                r.length > 45 &&
                  e.createElement(ka, { onClick: s }, o ? 'Hide pattern' : 'Show pattern'),
              );
        }
        function _a({ schema: t }) {
          const { hideSchemaPattern: r } = e.useContext(de);
          return t &&
            ...
            ? e.createElement(
                ...
                null,
                '[ items',
                t.displayFormat && e.createElement(ma, null, ' <', t.displayFormat, ' >'),
                e.createElement(Pa, { constraints: t.constraints }),
                e.createElement(Ta, { schema: t }),
                t.items && e.createElement(_a, { schema: t.items }),
                ' ]',
              )
            : null;
        }
...
`;
        var Da = Object.defineProperty,
          ...
          qa = (e, t, r) =>
            t in e
              ...
              : (e[t] = r),
          Fa = (e, t) => {
            for (var r in t || (t = {})) Ma.call(t, r) && qa(e, r, t[r]);
            if (za) for (var r of za(t)) Na.call(t, r) && qa(e, r, t[r]);
            return e;
          };
        const Ba = (0, la.observer)(t => {
            const { enumSkipQuotes: r, hideSchemaTitles: n } = e.useContext(de),
              ...
              f = e.useMemo(
                () =>
                  !o || (void 0 === i.example && void 0 === i.examples)
                    ? null
                    : void 0 !== i.examples
                    ? e.createElement(Ca, { field: i })
                    : e.createElement(Ia, {
                        label: L('example') + ':',
                        value: et(i, i.example),
                        raw: Boolean(i.in),
                      }),
                [i, o],
              );
            return e.createElement(
              ...
              e.createElement(
                'div',
                null,
                e.createElement(ua, null, a.typePrefix),
                e.createElement(da, null, a.displayType),
                a.displayFormat && e.createElement(ma, null, ' ', '<', a.displayFormat, '>', ' '),
                a.contentEncoding &&
                  e.createElement(ma, null, ' ', '<', a.contentEncoding, '>', ' '),
                a.contentMediaType &&
                  e.createElement(ma, null, ' ', '<', a.contentMediaType, '>', ' '),
                a.title && !n && e.createElement(ha, null, ' (', a.title, ') '),
                e.createElement(Pa, { constraints: a.constraints }),
                e.createElement(Ta, { schema: a }),
                a.isCircular && e.createElement(ya, null, ' ', L('recursive'), ' '),
                h && a.items && e.createElement(_a, { schema: a.items }),
              ),
              c &&
                e.createElement(
                  'div',
                  null,
                  e.createElement(Ci, { type: 'warning' }, ' ', L('deprecated'), ' '),
                ),
              e.createElement(Ia, { raw: m, label: L('default') + ':', value: a.default }),
              !s && e.createElement(Sa, { isArrayType: h, values: a.enum }),
              ' ',
              f,
              e.createElement(ja, { extensions: Fa(Fa({}, p), a.extensions) }),
              e.createElement('div', null, e.createElement(As, { compact: !0, source: l })),
              a.externalDocs && e.createElement(Ea, { externalDocs: a.externalDocs, compact: !0 }),
              (s && s(t)) || null,
              (d && e.createElement(Ia, { label: L('const') + ':', value: d })) || null,
            );
          }),
          Qa = e.memo(Ba);
        var Ua = Object.defineProperty,
          Wa = (Object.getOwnPropertyDescriptor, Object.getOwnPropertySymbols),
          Va = Object.prototype.hasOwnProperty,
          Ha = Object.prototype.propertyIsEnumerable,
          Ja = (e, t, r) =>
            t in e
              ? Ua(e, t, { enumerable: !0, configurable: !0, writable: !0, value: r })
              : (e[t] = r);
          ...
          render() {
            const { className: t = '', field: r, isLast: n, expandByDefault: o } = this.props,
              ...
              u = e.createElement(
                e.Fragment,
                null,
                'additionalProperties' === l && e.createElement(ga, null, 'additional property'),
                'patternProperties' === l && e.createElement(ga, null, 'pattern property'),
                a && e.createElement(fa, null, 'required'),
              ),
              d = c
                ? e.createElement(
                    ca,
                    ...
                    e.createElement(
                      ...
                      e.createElement(ji, { direction: p ? 'down' : 'right' }),
                    ),
                    u,
                  )
                : e.createElement(
              ...
              e.createElement(
                ...
                e.createElement(
                  ...
                  e.createElement(
                    Qa,
                    ((e, t) => {
                      for (var r in t || (t = {})) Va.call(t, r) && Ja(e, r, t[r]);
                      if (Wa) for (var r of Wa(t)) Ha.call(t, r) && Ja(e, r, t[r]);
                      return e;
                    })({}, this.props),
                  ),
                ),
        ...
        Object.defineProperty, Object.getOwnPropertyDescriptor;
        let Za = class extends e.Component {
          constructor() {
            super(...arguments),
        ...
        var Xa = Object.defineProperty,
          ...
          ol = (e, t, r) =>
            t in e
              ...
              : (e[t] = r),
          il = (e, t) => {
            for (var r in t || (t = {})) rl.call(t, r) && ol(e, r, t[r]);
            if (tl) for (var r of tl(t)) nl.call(t, r) && ol(e, r, t[r]);
            return e;
          },
          sl = (e, t) => Ka(e, el(t));
        const al = re.div`
...
`;
        class ll extends e.PureComponent {
          render() {
            const t = this.props.schema,
              r = t.items,
              n = void 0 === t.minItems && void 0 === t.maxItems ? '' : `(${at(t)})`;
            return t.fields
              ? e.createElement(Ga, sl(il({}, this.props), { level: this.props.level }))
              ...
              ? e.createElement(
                  ...
                  e.createElement(
                    al,
                    null,
                    e.createElement(Al, sl(il({}, this.props), { schema: r })),
                  ),
                  e.createElement(Qi, null),
                )
              : e.createElement('div', null, e.createElement(da, null, t.displayType));
          }
        }
        var cl = Object.defineProperty,
          ...
          gl = (e, t, r) =>
            t in e
              ? cl(e, t, { enumerable: !0, configurable: !0, writable: !0, value: r })
              : (e[t] = r),
          yl = (e, t, r, n) => {
            for (var o, i = n > 1 ? void 0 : n ? ul(t, r) : t, s = e.length - 1; s >= 0; s--)
              (o = e[s]) && (i = (n ? o(t, r, i) : o(i)) || i);
            return n && i && cl(t, r, i), i;
          };
          ...
          render() {
            ...
            return e.createElement(
              ...
              e.createElement(
                ...
                null,
                t.map((t, n) =>
                  e.createElement(bl, { key: t.pointer, schema: r, subSchema: t, idx: n }),
                ),
              ),
              e.createElement(
                'div',
              ...
              e.createElement(Pa, { constraints: n.constraints }),
              e.createElement(
                Al,
                ((o = ((e, t) => {
        ...
        xl = yl([la.observer], xl);
        const vl = (0, la.observer)(({ schema: t }) =>
          e.createElement(
            'div',
            null,
            e.createElement(da, null, t.displayType),
            t.title && e.createElement(ha, null, ' ', t.title, ' '),
            e.createElement(ya, null, ' ', L('recursive'), ' '),
          ),
        );
        var wl = Object.defineProperty,
          kl = Object.defineProperties,
          Ol = (Object.getOwnPropertyDescriptor, Object.getOwnPropertyDescriptors),
          El = Object.getOwnPropertySymbols,
          Sl = Object.prototype.hasOwnProperty,
          $l = Object.prototype.propertyIsEnumerable,
          Rl = (e, t, r) =>
            t in e
              ? wl(e, t, { enumerable: !0, configurable: !0, writable: !0, value: r })
              : (e[t] = r),
          jl = (e, t) => {
            for (var r in t || (t = {})) Sl.call(t, r) && Rl(e, r, t[r]);
            if (El) for (var r of El(t)) $l.call(t, r) && Rl(e, r, t[r]);
            return e;
          },
          Cl = (e, t) => kl(e, Ol(t));
        let Al = class extends e.Component {
          render() {
            var t;
            const r = this.props,
              { schema: n } = r,
            ...
            if (void 0 !== a) return e.createElement(xl, jl({ schema: n }, o));
            const p = I(s) ? s : [s];
            if (p.includes('object')) {
              if (null == (t = n.fields) ? void 0 : t.length)
                return e.createElement(Ga, Cl(jl({}, this.props), { level: i }));
            } else if (p.includes('array'))
              return e.createElement(ll, Cl(jl({}, this.props), { level: i }));
            const u = {
              schema: n,
              name: '',
              required: !1,
            ...
            return e.createElement('div', null, e.createElement(Qa, { field: u }));
          }
        };
        Al = ((e, t, r, n) => {
          for (var o, i = t, s = e.length - 1; s >= 0; s--) (o = e[s]) && (i = o(i) || i);
        ...
        var Pl = Object.defineProperty,
          ...
          zl = (e, t, r) =>
            t in e
              ...
              : (e[t] = r);
        class Ml extends e.PureComponent {
          constructor() {
            super(...arguments),
              (this.renderDropdown = t => {
                return e.createElement(
                  xs,
                  ((r = ((e, t) => {
                    for (var r in t || (t = {})) Ll.call(t, r) && zl(e, r, t[r]);
                    if (_l) for (var r of _l(t)) Dl.call(t, r) && zl(e, r, t[r]);
                    return e;
                  })({ Label: hs, Dropdown: oa }, t)),
                  Il(r, Tl({ variant: 'dark' }))),
                );
                var r;
              });
          }
          ...
          get mediaModel() {
            ...
            return (
              this._mediaModel ||
                (this._mediaModel = new Zn(e, 'json', !1, Ml.getMediaType(t, r), n)),
              this._mediaModel
            );
          }
          render() {
...
`;
        function Yl({ children: t, height: r }) {
          const n = e.createRef(),
            [o, i] = e.useState(!1),
            [s, a] = e.useState(!1);
          return (
...
`,
            ...
            return e.createElement(
              ...
              !!i.length &&
                e.createElement(
                  ...
                  null,
                  o || null,
                  e.createElement(Hl, null, e.createElement('b', null, ' Scopes: ')),
                  e.createElement(
                    Yl,
                    { height: '4em' },
                    e.createElement(
            ...
            n.apiKey
              ? e.createElement(
                  ...
                  e.createElement(
                    Hl,
                    null,
                    e.createElement('b', null, R(n.apiKey.in || ''), ' parameter name: '),
              ...
              ? Object.keys(n.flows).map(t =>
                  e.createElement(Kl, { key: t, type: t, RequiredScopes: r, flow: n.flows[t] }),
                )
              : null,
          );
        }
        ...
        class rc extends e.PureComponent {
          render() {
                ...
                e.createElement(
                  ...
                  e.createElement(
                    ...
                    e.createElement(
                      gi,
                      null,
                      e.createElement($i, { to: t.sectionId }),
                      t.displayName,
                    ),
                    e.createElement(As, { source: t.description || '' }),
                    e.createElement(
                      Jl,
                      null,
                      e.createElement(
                        ...
                        e.createElement('span', null, tc[t.type] || t.type),
                      ),
                      e.createElement(ec, { scheme: t }),
                    ),
                  ),
                ),
              ),
        ...
        function oc(e, t) {
          return nc(this, arguments, function* (e, t, r = {}) {
            const n = yield xe(e || t);
            return new ic(n, t, r);
          });
        }
        class ic {
          constructor(e, t, r = {}, n = !0) {
            (this.marker = new Jt()),
              (this.disposer = null),
              (this.rawOptions = r),
              (this.options = new H(r, sc)),
              (this.scroll = new si(this.options)),
              ri.updateOnHistory(Vt.currentId, this.scroll),
              (this.spec = new Do(e, t, this.options)),
              (this.menu = new ri(this.spec, this.scroll, Vt)),
              this.options.disableSearch ||
                ((this.search = new ai()),
                n && this.search.indexItems(this.menu.items),
                (this.disposer = (0, fe.observe)(this.menu, 'activeItemIdx', e => {
                  this.updateMarkOnMenu(e.newValue);
                })));
          }
          static fromJS(e) {
            const t = new ic(e.spec.data, e.spec.url, e.options, !1);
            return (
            ...
            return e.createElement(
              ...
              e.createElement(
                ...
                e.createElement(
                  li,
                  { className: 'api-info' },
                  e.createElement(ac, null, r.title, ' ', u),
                  !o &&
                    e.createElement(
                      'p',
                      null,
                  ...
                  e.createElement(
                    ...
                    ((r.license || r.contact || r.termsOfService) &&
                      e.createElement(
                        pc,
                        null,
                        e.createElement(uc, null, c, ' ', l, ' ', a, ' ', p),
                      )) ||
                      null,
                  ),
                  e.createElement(As, {
                  ...
                  n && e.createElement(Ea, { externalDocs: n }),
                ),
              ),
            );
          }
        ...
        let gc = class extends e.Component {
          render() {
            ...
            const n = r.href || (t.contact && t.contact.url),
              ...
              i = e.createElement(hc, { src: r.url, alt: o });
            return e.createElement(
              mc,
              { style: { backgroundColor: r.backgroundColor } },
              n ? ((s = n), t => e.createElement(fc, { href: s }, t))(i) : i,
            );
            var s;
          }
        };
        ...
        var yc = Object.defineProperty,
          ...
          wc = (e, t, r) =>
            t in e
              ...
              : (e[t] = r),
          kc = (e, t) => {
            for (var r in t || (t = {})) xc.call(t, r) && wc(e, r, t[r]);
            if (bc) for (var r of bc(t)) vc.call(t, r) && wc(e, r, t[r]);
            return e;
          };
        class Oc extends e.Component {
          render() {
            return e.createElement(me, null, t =>
          ...
          renderWithOptionsAndStore(t, r) {
            ...
            const i = new Wr(t, this.props.parentId).renderMdWithComponents(n);
            return i.length
              ? i.map((t, n) => {
                  if ('string' == typeof t)
                    return e.cloneElement(
                      o(e.createElement(Cs, { html: t, inline: !1, compact: !1 })),
                      { key: n },
                    );
                  const i = t.component;
                  return e.createElement(
                    i,
                    kc({ key: n }, kc(kc({}, t.props), t.propsSelector(r))),
                  );
                })
              : null;
          }
        }
        var Ec = require('classnames'),
          Sc = r.n(Ec);
        function $c(e, t) {
          return void 0 === e
...
`,
  ...
  `,
          ...
          Ic = re.label.attrs(e => ({
            role: 'menuitem',
            className: Sc()('-depth' + e.depth, { active: e.active }),
          }))`
  cursor: pointer;
  ...
  ${e => Pc[e.depth]};
  background-color: ${e =>
    e.active ? jc(e.depth, e, 'activeBackgroundColor') : e.theme.sidebar.backgroundColor};
...
`,
          Mc = re(t => {
            ...
            return e.createElement(
              ...
              e.createElement(zc, { type: s }, xt(s)),
              e.createElement(ji, {
                size: '1.5em',
                direction: n ? 'down' : 'right',
                float: 'left',
              }),
              e.createElement(Dc, { deprecated: a }, r),
              a ? e.createElement(Ci, { type: 'warning' }, ' ', L('deprecated'), ' ') : null,
            );
          })`
  padding: 10px;
  border-radius: 2px;
...
`;
        class Jc extends e.Component {
          ...
          render() {
            ...
            return e.createElement(de.Consumer, null, i =>
              e.createElement(
                Fc,
                null,
                e.createElement(
                  ...
                  e.createElement(Bc, null, t.path),
                  e.createElement(ji, {
                    float: 'right',
                    color: r ? 'black' : 'white',
                    size: '20px',
                ...
                e.createElement(
                  ...
                  t.servers.map(r => {
                    const o = i.expandDefaultServerVariables ? dt(r.url, r.variables) : r.url,
                      s = $(o);
                    return e.createElement(
                      Vc,
                      { key: o },
                      e.createElement(As, { source: r.description || '', compact: !0 }),
                      e.createElement(
                        qc,
                        null,
                        e.createElement(
          ...
          render() {
            ...
            return r && r.length
              ? e.createElement(
                  'div',
                  { key: t },
                  e.createElement(bi, null, t, ' Parameters'),
                  e.createElement(
                    Mi,
                    null,
                    e.createElement(
                      ...
                      null,
                      m(r, (t, r) =>
                        e.createElement(Ya, { key: t.name, isLast: r, field: t, showExamples: !0 }),
                      ),
                    ),
                  ),
                )
            ...
            const r = t.activeMimeIdx,
              ...
              o = ({ children: t }) =>
                this.props.withLabel
                  ? e.createElement(na, null, e.createElement(ra, null, 'Content type'), t)
                  : t;
            return e.createElement(
              e.Fragment,
              null,
        ...
        var Gc = Object.defineProperty,
          ...
          tp = (e, t, r) =>
            t in e
              ...
              : (e[t] = r);
        const rp = ['path', 'query', 'cookie', 'header'];
        class np extends e.PureComponent {
          orderParams(e) {
            const t = {};
            return (
              e.forEach(e => {
          ...
          render() {
            ...
            return e.createElement(
              e.Fragment,
              null,
              o.map(t => e.createElement(Yc, { key: t, place: t, parameters: n[t] })),
              i && e.createElement(ip, { content: i, description: s }),
            );
          }
        }
        function op(t) {
          return e.createElement(
            ...
            e.createElement(
              xs,
              ((e, t) => {
                for (var r in t || (t = {})) Kc.call(t, r) && tp(e, r, t[r]);
                if (Xc) for (var r of Xc(t)) ep.call(t, r) && tp(e, r, t[r]);
                return e;
              })({}, t),
            ),
          );
        ...
        function ip(t) {
          const { content: r, description: n } = t,
            { isRequestType: o } = r;
          return e.createElement(Zc, { content: r, renderDropdown: op }, ({ schema: t }) =>
            e.createElement(
              e.Fragment,
              null,
              void 0 !== n && e.createElement(As, { source: n }),
              'object' === (null == t ? void 0 : t.type) &&
                e.createElement(Pa, { constraints: (null == t ? void 0 : t.constraints) || [] }),
              e.createElement(Al, { skipReadOnly: o, skipWriteOnly: !o, key: 'schema', schema: t }),
            ),
          );
        }
        const sp = e.memo(function ({
            title: t,
            type: r,
            empty: n,
            code: o,
            ...
            return e.createElement(
              ...
              e.createElement(pp, null, o, ' '),
              e.createElement(As, { compact: !0, inline: !0, source: t }),
            );
          }),
          ap = re(sp)`
  display: block;
...
`;
          ...
          render() {
            ...
            return void 0 === t || 0 === t.length
              ...
              : e.createElement(
                  Mi,
                  null,
                  e.createElement(cp, null, ' Response Headers '),
                  e.createElement(
                    'tbody',
                    null,
                    m(t, (t, r) =>
                      e.createElement(Ya, { isLast: r, key: t.name, field: t, showExamples: !0 }),
                    ),
                  ),
                );
          }
        ...
        var dp = Object.defineProperty,
          ...
          gp = (e, t, r) =>
            t in e
              ...
              : (e[t] = r);
        class yp extends e.PureComponent {
          constructor() {
            super(...arguments),
              (this.renderDropdown = t =>
                e.createElement(
                  ...
                  e.createElement(
                    xs,
                    ((e, t) => {
                      for (var r in t || (t = {})) mp.call(t, r) && gp(e, r, t[r]);
                      if (hp) for (var r of hp(t)) fp.call(t, r) && gp(e, r, t[r]);
                      return e;
                    })({}, t),
                  ),
                ));
          ...
          render() {
            ...
            return e.createElement(
              e.Fragment,
              null,
              t && e.createElement(As, { source: t }),
              e.createElement(ja, { extensions: r }),
              e.createElement(up, { headers: n }),
              e.createElement(
                Zc,
                ...
                ({ schema: t }) =>
                  e.createElement(
                    ...
                    e.createElement(Al, { skipWriteOnly: !0, key: 'schema', schema: t }),
                  ),
              ),
            );
          }
        }
        const bp = (0, la.observer)(({ response: t }) => {
            const {
                extensions: r,
                headers: n,
                type: o,
            ...
            return e.createElement(
              ...
              l && !u && e.createElement(lp, null, e.createElement(yp, { response: t })),
            );
          }),
          xp = re.h3`
  font-size: 1.3em;
  ...
  font-weight: normal;
`;
        class vp extends e.PureComponent {
          render() {
            ...
            return t && 0 !== t.length
              ? e.createElement(
                  'div',
                  null,
                  e.createElement(xp, null, L(r ? 'callbackResponses' : 'responses')),
                  t.map(t => e.createElement(bp, { key: t.code, response: t })),
                )
              : null;
          }
        }
        function wp(t) {
          ...
          return 0 === r.schemes.length
            ? e.createElement(Bl, { expanded: o }, 'None')
            : e.createElement(
                Bl,
                { expanded: o },
                i && '(',
                r.schemes.map(t =>
                  e.createElement(
                    ...
                    o && t.scopes.length
                      ? [' (', t.scopes.map(t => e.createElement(ql, { key: t }, t)), ') ']
                      : null,
                  ),
                ),
                i && ') ',
          ...
          return e.createElement(
            ...
            e.createElement(
              ...
              e.createElement(
                Ql,
                { onClick: () => i(!o) },
                e.createElement(Wl, null, 'Authorizations:'),
                e.createElement(ji, { size: '1.3em', direction: o ? 'down' : 'right' }),
              ),
              e.createElement(
                Ul,
                { expanded: o },
              ...
              a.map((t, r) =>
                e.createElement(
                  ...
                  e.createElement(ec, {
                    key: t.id,
                    scheme: t,
                    RequiredScopes: e.createElement(kp, { scopes: Sp(t.id, s) }),
                  }),
                ),
              ),
          );
        ...
        Object.defineProperty, Object.getOwnPropertyDescriptor;
        let $p = class extends e.Component {
          render() {
            ...
            return e.createElement(
              ...
              o &&
                e.createElement(
                  Rp,
                  null,
                  void 0 !== r && e.createElement(As, { source: r }),
                  n && e.createElement(Ea, { externalDocs: n }),
                ),
              e.createElement(Jc, { operation: this.props.operation, inverted: !0, compact: !0 }),
              e.createElement(ja, { extensions: t.extensions }),
              e.createElement(Op, { securities: t.security }),
              e.createElement(np, { parameters: t.parameters, body: t.requestBody }),
              e.createElement(vp, { responses: t.responses, isCallback: t.isCallback }),
            );
          }
        };
        $p = ((e, t, r, n) => {
...
`;
        Object.defineProperty, Object.getOwnPropertyDescriptor;
        let jp = class extends e.Component {
          constructor() {
            super(...arguments),
              (this.toggle = () => {
          ...
          render() {
            ...
            return e.createElement(
              ...
              r && e.createElement($p, { operation: this.props.callbackOperation }),
            );
          }
        };
        jp = ((e, t, r, n) => {
          ...
          render() {
            ...
            return t && 0 !== t.length
              ? e.createElement(
                  'div',
                  null,
                  e.createElement(Ap, null, ' Callbacks '),
                  t.map(t =>
                    t.operations.map((r, n) =>
                      e.createElement(jp, { key: `${t.name}_${n}`, callbackOperation: r }),
                    ),
                  ),
                )
              : null;
...
`;
        ...
        let Pp = class extends e.Component {
          ...
          render() {
            ...
            const r = ({ children: t }) =>
              this.props.label
                ? e.createElement(na, null, e.createElement(ra, null, this.props.label), t)
                : t;
            return e.createElement(
              e.Fragment,
              null,
        ...
        var Ip = Object.defineProperty,
          ...
          _p = (Object.getOwnPropertyDescriptor, Object.getOwnPropertyDescriptors),
            ...
            super(...arguments),
              (this.renderDropdown = t => {
                return e.createElement(
                  xs,
                  ((r = ((e, t) => {
                    for (var r in t || (t = {})) Dp.call(t, r) && Mp(e, r, t[r]);
                    if (Lp) for (var r of Lp(t)) zp.call(t, r) && Mp(e, r, t[r]);
                    return e;
                  })({ Label: ta, Dropdown: oa }, t)),
                  Tp(r, _p({ variant: 'dark' }))),
                );
                var r;
              });
          }
        ...
        class qp extends e.Component {
          render() {
            const t = this.props.callback.codeSamples.find(e => go(e));
            return t
              ? e.createElement(Fp, null, e.createElement(Np, { content: t.requestBodyContent }))
              : null;
          }
        }
        const Fp = re.div`
...
`;
        var Bp = Object.defineProperty,
          ...
          Up = (Object.getOwnPropertyDescriptor, Object.getOwnPropertyDescriptors),
            ...
            super(...arguments),
              (this.renderDropdown = t => {
                return e.createElement(
                  xs,
                  ((r = ((e, t) => {
                    for (var r in t || (t = {})) Vp.call(t, r) && Jp(e, r, t[r]);
                    if (Wp) for (var r of Wp(t)) Hp.call(t, r) && Jp(e, r, t[r]);
                    return e;
                  })({ Label: ta, Dropdown: oa }, t)),
                  Qp(r, Up({ variant: 'dark' }))),
                );
                var r;
              });
          }
            ...
            return (
              (n &&
                e.createElement(
                  'div',
                  null,
                  e.createElement(yi, null, ' ', L('requestSamples'), ' '),
                  e.createElement(
                    Wi,
                    { defaultIndex: 0 },
                    e.createElement(
                      ...
                      e.createElement(
                        ...
                        go(t)
                          ? e.createElement(
                              'div',
                              null,
                              e.createElement(Np, { content: t.requestBodyContent }),
                            )
                          : e.createElement(Gs, { lang: t.lang, source: t.source }),
                      ),
                    ),
                  ),
                )) ||
            ...
            return (
              (r.length > 0 &&
                e.createElement(
                  'div',
                  null,
                  e.createElement(yi, null, ' ', L('responseSamples'), ' '),
                  e.createElement(
                    Wi,
                    { defaultIndex: 0 },
                    e.createElement(
                    ...
                    r.map(t =>
                      e.createElement(
                        Ui.TabPanel,
                        { key: t.code },
                        e.createElement('div', null, e.createElement(Np, { content: t.content })),
                      ),
                    ),
                  ),
                )) ||
...
`,
          au = (0, la.observer)(({ operation: t }) => {
            const {
              ...
              l = !(!n && !i),
              { showWebhookVerb: c } = e.useContext(de);
            return e.createElement(de.Consumer, null, p => {
              return e.createElement(
                di,
                ((u = ((e, t) => {
                ...
                e.createElement(
                  ...
                  p.pathInMiddlePanel && !s && e.createElement(Jc, { operation: t, inverted: !0 }),
                  l &&
                    e.createElement(
                      su,
                      null,
                      void 0 !== n && e.createElement(As, { source: n }),
                      i && e.createElement(Ea, { externalDocs: i }),
                    ),
                  e.createElement(ja, { extensions: t.extensions }),
                  e.createElement(Op, { securities: t.security }),
                  e.createElement(np, { parameters: t.parameters, body: t.requestBody }),
                  e.createElement(vp, { responses: t.responses }),
                  e.createElement(Cp, { callbacks: t.callbacks }),
                ),
                e.createElement(
                  ui,
                  null,
                  !p.pathInMiddlePanel && !s && e.createElement(Jc, { operation: t }),
                  e.createElement(Gp, { operation: t }),
                  e.createElement(Xp, { operation: t }),
                  e.createElement(Yp, { callbacks: t.callbacks }),
                ),
              );
              var u, d;
            });
        ...
        var lu = Object.defineProperty,
          ...
          hu = (e, t, r) =>
            t in e
              ? lu(e, t, { enumerable: !0, configurable: !0, writable: !0, value: r })
              : (e[t] = r),
          mu = (e, t, r, n) => {
            for (var o, i = n > 1 ? void 0 : n ? cu(t, r) : t, s = e.length - 1; s >= 0; s--)
              (o = e[s]) && (i = (n ? o(t, r, i) : o(i)) || i);
            return n && i && lu(t, r, i), i;
          };
        let fu = class extends e.Component {
          render() {
            const t = this.props.items;
            return 0 === t.length ? null : t.map(t => e.createElement(gu, { key: t.id, item: t }));
          }
        };
        fu = mu([la.observer], fu);
        let gu = class extends e.Component {
          render() {
            ...
            switch (n) {
              ...
              default:
                ...
                break;
              case 'operation':
                r = e.createElement(xu, { item: t });
            }
            return e.createElement(
              e.Fragment,
              null,
              r && e.createElement(ci, { id: t.id, underlined: 'operation' === t.type }, r),
              t.items && e.createElement(fu, { items: t.items }),
            );
          }
        };
        gu = mu([la.observer], gu);
        const yu = t => e.createElement(li, { compact: !0 }, t);
            ...
            return e.createElement(
              ...
              e.createElement(
                ...
                e.createElement(
                  li,
                  { compact: !1 },
                  e.createElement(i, null, e.createElement($i, { to: this.props.item.id }), t),
                ),
              ),
              e.createElement(Oc, { parentId: this.props.item.id, source: r || '', htmlWrap: yu }),
              n &&
                e.createElement(
                  di,
                  null,
                  e.createElement(li, null, e.createElement(Ea, { externalDocs: n })),
                ),
            );
          }
        };
        bu = mu([la.observer], bu);
        let xu = class extends e.Component {
          render() {
            return e.createElement(au, { operation: this.props.item });
          }
        };
        xu = mu([la.observer], xu);
        var vu = Object.defineProperty,
          wu = Object.defineProperties,
          ku = (Object.getOwnPropertyDescriptor, Object.getOwnPropertyDescriptors),
          Ou = Object.getOwnPropertySymbols,
          Eu = Object.prototype.hasOwnProperty,
          Su = Object.prototype.propertyIsEnumerable,
          $u = (e, t, r) =>
            t in e
              ? vu(e, t, { enumerable: !0, configurable: !0, writable: !0, value: r })
              : (e[t] = r);
        let Ru = class extends e.Component {
          constructor() {
            super(...arguments),
          ...
          scrollIntoViewIfActive() {
            this.props.item.active && this.ref.current && u(this.ref.current);
          }
          render() {
            ...
            return e.createElement(
              ...
              'operation' === t.type
                ? e.createElement(
                    ju,
                    ((n = ((e, t) => {
                      for (var r in t || (t = {})) Eu.call(t, r) && $u(e, r, t[r]);
                      if (Ou) for (var r of Ou(t)) Su.call(t, r) && $u(e, r, t[r]);
                      return e;
                    })({}, this.props)),
                    wu(n, ku({ item: t }))),
                  )
        ...
        const ju = (0, la.observer)(t => {
          const { item: r } = t,
            n = e.createRef(),
            { showWebhookVerb: o } = e.useContext(de);
          return (
            e.useEffect(() => {
              t.item.active && n.current && u(n.current);
            }, [t.item.active, n]),
            e.createElement(
              Ic,
              { depth: r.depth, active: r.active, deprecated: r.deprecated, ref: n },
              r.isWebhook
                ? e.createElement(Rc, { type: 'hook' }, o ? r.httpVerb : L('webhook'))
                : e.createElement(Rc, { type: r.httpVerb }, xt(r.httpVerb)),
              e.createElement(Tc, { width: 'calc(100% - 38px)' }, r.sidebarLabel, t.children),
            )
          );
        });
        var Cu = Object.defineProperty,
          Au = (Object.getOwnPropertyDescriptor, Object.getOwnPropertySymbols),
          ...
          Tu = (e, t, r) =>
            t in e
              ...
              : (e[t] = r);
        let _u = class extends e.Component {
          render() {
            ...
            return e.createElement(
              Cc,
              ((e, t) => {
                for (var r in t || (t = {})) Pu.call(t, r) && Tu(e, r, t[r]);
                if (Au) for (var r of Au(t)) Iu.call(t, r) && Tu(e, r, t[r]);
                return e;
              })({ className: n, style: this.props.style, expanded: o }, r ? { role: 'menu' } : {}),
              t.map((t, r) =>
                e.createElement(Ru, { key: r, item: t, onActivate: this.props.onActivate }),
              ),
            );
          }
        };
        ...
        let Du = class extends e.Component {
          ...
          render() {
            ...
            return e.createElement(
              ...
              e.createElement(_u, { items: t.items, onActivate: this.activate, root: !0 }),
              e.createElement(
                _c,
                null,
                e.createElement(
        ...
        const zu = ({ open: t }) => {
          ...
          Mu = ({ size: t = 10, className: r = '', style: n }) =>
            e.createElement(
              'svg',
              {
                className: r,
...
`;
        let Uu = class extends e.Component {
          ...
          componentDidMount() {
            Fu && Fu.add(this.stickyElement),
              this.setState({ offsetTop: this.getScrollYOffset(this.context) });
          }
          componentWillUnmount() {
            Fu && Fu.remove(this.stickyElement);
          }
          getScrollYOffset(e) {
            let t;
            return (
              (t =
                void 0 !== this.props.scrollYOffset
                  ? H.normalizeScrollYOffset(this.props.scrollYOffset)()
                  : e.scrollYOffset()),
              t + 'px'
            );
          }
...
`;
        ...
        class nd extends e.PureComponent {
          constructor(e) {
            super(e),
          ...
          render() {
            ...
            return e.createElement(
              Zu,
              { role: 'search', 'data-role': 'redoc-search' },
              this.state.term && e.createElement(ed, { onClick: this.clear }, '×'),
              ...
              this.state.term && this.state.noResults
                ? e.createElement(Ku, { 'data-role': 'search:results' }, L('noResultsFound'))
                : null,
            );
          }
        }
        (nd.contextType = de),
          ((e, t, r, n) => {
            for (var o, i = rd(t, r), s = e.length - 1; s >= 0; s--)
              (o = e[s]) && (i = o(t, r, i) || i);
            i && td(t, r, i);
          })([we.bind, (0, we.debounce)(400)], nd.prototype, 'searchCallback');
        class od extends e.Component {
          componentDidMount() {
                ...
                e.createElement(
                  ...
                  e.createElement(
                    ...
                    e.createElement(
                      ...
                      e.createElement(gc, { info: t.info }),
                      e.createElement(Vu, null, s.spec.info.title),
                      (!n.disableSearch &&
                        e.createElement(nd, {
                          search: o,
                          marker: i,
                        ...
                        null,
                      e.createElement(Du, { menu: r }),
                    ),
                    e.createElement(
                      Ju,
                      { className: 'api-content' },
                      e.createElement(dc, { store: s }),
                      e.createElement(fu, { items: r.items }),
                    ),
                    e.createElement(Yu, null),
                  ),
                  e.createElement(ue.UnifiedFooter, { hideLocale: !0 }),
                ),
              ),
            );
          }
        }
        od.propTypes = { store: pe.instanceOf(ic).isRequired };
        const id = function (t) {
            ...
            e.createElement(
              ...
              ({ loading: t, store: r }) =>
                t
                  ? a
                    ? null
                    : e.createElement(ce, { color: l.theme.colors.primary.main })
                  : e.createElement(od, { store: r }),
            ),
          );
        };
      })(),
