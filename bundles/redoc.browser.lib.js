...
`,ia=re.div`
  ...
  font-size: 12px;
  color: #ee807f;
`;class sa extends e.Component{constructor(){super(...arguments),this.state={activeIdx:0},this.switchMedia=({idx:e})=>{void 0!==e&&this.setState({activeIdx:e})}}render(){const{activeIdx:t}=this.state,r=this.props.mediaType.examples||{},n=this.props.mediaType.name,o=e.createElement(ia,null,"No sample"),i=Object.keys(r);if(0===i.length)return o;if(i.length>1){const o=i.map(((e,t)=>({value:r[e].summary||e,idx:t}))),s=r[i[t]],a=s.description;return e.createElement(aa,null,e.createElement(na,null,e.createElement(ra,null,"Example"),this.props.renderDropdown({value:o[t].value,options:o,onChange:this.switchMedia,ariaLabel:"Example"})),e.createElement("div",null,a&&e.createElement(As,{source:a}),e.createElement(Ks,{example:s,mimeType:n})))}{const t=r[i[0]];return e.createElement(aa,null,t.description&&e.createElement(As,{source:t.description}),e.createElement(Ks,{example:t,mimeType:n}))}}}const aa=re.div`
  margin-top: 15px;
...
`,Ra=re(ks)`
  margin: 2px 0;
`;class ja extends e.PureComponent{render(){const t=this.props.extensions;return e.createElement(de.Consumer,null,(r=>e.createElement(e.Fragment,null,r.showExtensions&&Object.keys(t).map((r=>e.createElement(Ra,{key:r},e.createElement(pa,null," ",r.substring(2),": ")," ",e.createElement(va,null,"string"==typeof t[r]?t[r]:JSON.stringify(t[r]))))))))}}function Ca({field:t}){return t.examples?e.createElement(e.Fragment,null,e.createElement(pa,null," ",L("examples"),": "),I(t.examples)?t.examples.map(((r,n)=>{const o=et(t,r),i=t.in?String(o):JSON.stringify(o);return e.createElement(e.Fragment,{key:n},e.createElement(xa,null,i)," ")})):e.createElement(Aa,null,Object.values(t.examples).map(((r,n)=>e.createElement("li",{key:n+r.value},e.createElement(xa,null,et(t,r.value))," -"," ",r.summary||r.description))))):null}const Aa=re.ul`
  margin-top: 1em;
...
`,Nc=re(Rc)`
  margin: 0 5px 0 0;
`,Fc=re((t=>{const{name:r,opened:n,className:o,onClick:i,httpVerb:s,deprecated:a}=t;return e.createElement(zc,{className:o,onClick:i||void 0},e.createElement(Nc,{type:s},xt(s)),e.createElement(ji,{size:"1.5em",direction:n?"down":"right",float:"left"}),e.createElement(Mc,{deprecated:a},r),a?e.createElement(Ci,{type:"warning"}," ",L("deprecated")," "):null)}))`
  padding: 10px;
  border-radius: 2px;
  margin-bottom: 4px;
  line-height: 1.5em;
...
`,qc=re.div`
  ...
  margin-bottom: 5px;
  margin-top: 5px;
`;class Bc extends e.PureComponent{constructor(){super(...arguments),this.selectElement=()=>{Ms.selectElement(this.child)}}render(){const{children:t}=this.props;return e.createElement("div",{ref:e=>this.child=e,onClick:this.selectElement,onFocus:this.selectElement,tabIndex:0,role:"button"},t)}}const Qc=re.div`
  cursor: pointer;
  position: relative;
  margin-bottom: 5px;
`,Uc=re.span`
...
`,dp=re.strong`
  vertical-align: top;
`;class hp extends e.PureComponent{render(){const{headers:t}=this.props;return void 0===t||0===t.length?null:e.createElement(Mi,null,e.createElement(up,null," Response Headers "),e.createElement("tbody",null,m(t,((t,r)=>e.createElement(Ya,{isLast:r,key:t.name,field:t,showExamples:!0})))))}}var mp=Object.defineProperty,fp=Object.getOwnPropertySymbols,gp=Object.prototype.hasOwnProperty,yp=Object.prototype.propertyIsEnumerable,bp=(e,t,r)=>t in e?mp(e,t,{enumerable:!0,configurable:!0,writable:!0,value:r}):e[t]=r;class xp extends e.PureComponent{constructor(){super(...arguments),this.renderDropdown=t=>e.createElement(bi,{key:"header"},"Response Schema: ",e.createElement(xs,((e,t)=>{for(var r in t||(t={}))gp.call(t,r)&&bp(e,r,t[r]);if(fp)for(var r of fp(t))yp.call(t,r)&&bp(e,r,t[r]);return e})({},t)))}render(){const{description:t,extensions:r,headers:n,content:o}=this.props.response;return e.createElement(e.Fragment,null,t&&e.createElement(As,{source:t}),e.createElement(ja,{extensions:r}),e.createElement(hp,{headers:n}),e.createElement(Xc,{content:o,renderDropdown:this.renderDropdown},(({schema:t})=>e.createElement(e.Fragment,null,"object"===(null==t?void 0:t.type)&&e.createElement(Pa,{constraints:(null==t?void 0:t.constraints)||[]}),e.createElement(Al,{skipWriteOnly:!0,key:"schema",schema:t})))))}}const vp=(0,la.observer)((({response:t})=>{const{extensions:r,headers:n,type:o,summary:i,description:s,code:a,expanded:l,content:c}=t,p=e.useMemo((()=>void 0===c?[]:c.mediaTypes.filter((e=>void 0!==e.schema))),[c]),u=e.useMemo((()=>!(r&&0!==Object.keys(r).length||0!==n.length||0!==p.length||s)),[r,n,p,s]);return e.createElement("div",null,e.createElement(cp,{onClick:()=>t.toggle(),type:o,empty:u,title:i||"",code:a,opened:l}),l&&!u&&e.createElement(pp,null,e.createElement(xp,{response:t})))})),wp=re.h3`
  font-size: 1.3em;
  padding: 0.2em 0;
  margin: 3em 0 1.1em;
  color: ${({theme:e})=>e.colors.text.primary};
  font-weight: normal;
`;class kp extends e.PureComponent{render(){const{responses:t,isCallback:r}=this.props;return t&&0!==t.length?e.createElement("div",null,e.createElement(wp,null,L(r?"callbackResponses":"responses")),t.map((t=>e.createElement(vp,{key:t.code,response:t})))):null}}function Op(t){const{security:r,showSecuritySchemeType:n,expanded:o}=t,i=r.schemes.length>1;return 0===r.schemes.length?e.createElement(Bl,{expanded:o},"None"):e.createElement(Bl,{expanded:o},i&&"(",r.schemes.map((t=>e.createElement(ql,{key:t.id},n&&`${tc[t.type]||t.type}: `,e.createElement("i",null,t.displayName),o&&t.scopes.length?[" (",t.scopes.map((t=>e.createElement(Fl,{key:t},t))),") "]:null))),i&&") ")}const Ep=({scopes:t})=>t.length?e.createElement("div",null,e.createElement("b",null,"Required scopes: "),t.map(((t,r)=>e.createElement(e.Fragment,{key:r},e.createElement("code",null,t)," ")))):null;function Sp(t){const r=Oi(),n=null==r?void 0:r.options.showSecuritySchemeType,[o,i]=(0,e.useState)(!1),{securities:s}=t;if(!(null==s?void 0:s.length)||(null==r?void 0:r.options.hideSecuritySection))return null;const a=null==r?void 0:r.spec.securitySchemes.schemes.filter((({id:e})=>s.find((t=>t.schemes.find((t=>t.id===e))))));return e.createElement(e.Fragment,null,e.createElement(Vl,{expanded:o},e.createElement(Ql,{onClick:()=>i(!o)},e.createElement(Wl,null,"Authorizations:"),e.createElement(ji,{size:"1.3em",direction:o?"down":"right"})),e.createElement(Ul,{expanded:o},s.map(((t,r)=>e.createElement(Op,{key:r,expanded:o,showSecuritySchemeType:n,security:t}))))),o&&(null==a?void 0:a.length)&&a.map(((t,r)=>e.createElement(Jl,{key:r},e.createElement("h5",null,e.createElement($p,null)," ",tc[t.type]||t.type,": ",t.id),e.createElement(As,{source:t.description||""}),e.createElement(ec,{key:t.id,scheme:t,RequiredScopes:e.createElement(Ep,{scopes:Rp(t.id,s)})})))))}const $p=()=>e.createElement("svg",{xmlns:"http://www.w3.org/2000/svg",viewBox:"0 0 24 24",width:"11",height:"11"},e.createElement("path",{fill:"currentColor",d:"M18 10V6A6 6 0 0 0 6 6v4H3v14h18V10h-3zM8 6c0-2.206 1.794-4 4-4s4 1.794 4 4v4H8V6zm11 16H5V12h14v10z"}));function Rp(e,t){const r=[];let n=t.length;for(;n--;){const o=t[n];let i=o.schemes.length;for(;i--;){const t=o.schemes[i];t.id===e&&Array.isArray(t.scopes)&&r.push(...t.scopes)}}return Array.from(new Set(r))}Object.defineProperty,Object.getOwnPropertyDescriptor;let jp=class extends e.Component{render(){const{operation:t}=this.props,{description:r,externalDocs:n}=t,o=!(!r&&!n);return e.createElement(qc,null,o&&e.createElement(Cp,null,void 0!==r&&e.createElement(As,{source:r}),n&&e.createElement(Ea,{externalDocs:n})),e.createElement(Zc,{operation:this.props.operation,inverted:!0,compact:!0}),e.createElement(ja,{extensions:t.extensions}),e.createElement(Sp,{securities:t.security}),e.createElement(ip,{parameters:t.parameters,body:t.requestBody}),e.createElement(kp,{responses:t.responses,isCallback:t.isCallback}))}};jp=((e,t,r,n)=>{for(var o,i=t,s=e.length-1;s>=0;s--)(o=e[s])&&(i=o(i)||i);return i})([la.observer],jp);const Cp=re.div`
  margin-bottom: ${({theme:e})=>3*e.spacing.unit}px;
`;Object.defineProperty,Object.getOwnPropertyDescriptor;let Ap=class extends e.Component{constructor(){super(...arguments),this.toggle=()=>{this.props.callbackOperation.toggle()}}render(){const{name:t,expanded:r,httpVerb:n,deprecated:o}=this.props.callbackOperation;return e.createElement(e.Fragment,null,e.createElement(Fc,{onClick:this.toggle,name:t,opened:r,httpVerb:n,deprecated:o}),r&&e.createElement(jp,{operation:this.props.callbackOperation}))}};Ap=((e,t,r,n)=>{for(var o,i=t,s=e.length-1;s>=0;s--)(o=e[s])&&(i=o(i)||i);return i})([la.observer],Ap);class Pp extends e.PureComponent{render(){const{callbacks:t}=this.props;return t&&0!==t.length?e.createElement("div",null,e.createElement(Ip,null," Callbacks "),t.map((t=>t.operations.map(((r,n)=>e.createElement(Ap,{key:`${t.name}_${n}`,callbackOperation:r})))))):null}}const Ip=re.h3`
  font-size: 1.3em;
  padding: 0.2em 0;
  margin: 3em 0 1.1em;
  color: ${({theme:e})=>e.colors.text.primary};
  font-weight: normal;
`;Object.defineProperty,Object.getOwnPropertyDescriptor;let Tp=class extends e.Component{constructor(e){super(e),this.switchItem=({idx:e})=>{this.props.items&&void 0!==e&&this.setState({activeItemIdx:e})},this.state={activeItemIdx:0}}render(){const{items:t}=this.props;if(!t||!t.length)return null;const r=({children:t})=>this.props.label?e.createElement(na,null,e.createElement(ra,null,this.props.label),t):t;return e.createElement(e.Fragment,null,e.createElement(r,null,this.props.renderDropdown({value:this.props.options[this.state.activeItemIdx].value,options:this.props.options,onChange:this.switchItem,ariaLabel:this.props.label||"Callback"})),this.props.children(t[this.state.activeItemIdx]))}};Tp=((e,t,r,n)=>{for(var o,i=t,s=e.length-1;s>=0;s--)(o=e[s])&&(i=o(i)||i);return i})([la.observer],Tp);var _p=Object.defineProperty,Lp=Object.defineProperties,Dp=(Object.getOwnPropertyDescriptor,Object.getOwnPropertyDescriptors),zp=Object.getOwnPropertySymbols,Mp=Object.prototype.hasOwnProperty,Np=Object.prototype.propertyIsEnumerable,Fp=(e,t,r)=>t in e?_p(e,t,{enumerable:!0,configurable:!0,writable:!0,value:r}):e[t]=r;let qp=class extends e.Component{constructor(){super(...arguments),this.renderDropdown=t=>{return e.createElement(xs,(r=((e,t)=>{for(var r in t||(t={}))Mp.call(t,r)&&Fp(e,r,t[r]);if(zp)for(var r of zp(t))Np.call(t,r)&&Fp(e,r,t[r]);return e})({Label:ta,Dropdown:oa},t),Lp(r,Dp({variant:"dark"}))));var r}}render(){const t=this.props.content;return void 0===t?null:e.createElement(Xc,{content:t,renderDropdown:this.renderDropdown,withLabel:!0},(t=>e.createElement(sa,{key:"samples",mediaType:t,renderDropdown:this.renderDropdown})))}};qp=((e,t,r,n)=>{for(var o,i=t,s=e.length-1;s>=0;s--)(o=e[s])&&(i=o(i)||i);return i})([la.observer],qp);class Bp extends e.Component{render(){const t=this.props.callback.codeSamples.find((e=>go(e)));return t?e.createElement(Qp,null,e.createElement(qp,{content:t.requestBodyContent})):null}}const Qp=re.div`
  margin-top: 15px;
`;var Up=Object.defineProperty,Wp=Object.defineProperties,Vp=(Object.getOwnPropertyDescriptor,Object.getOwnPropertyDescriptors),Hp=Object.getOwnPropertySymbols,Jp=Object.prototype.hasOwnProperty,Yp=Object.prototype.propertyIsEnumerable,Zp=(e,t,r)=>t in e?Up(e,t,{enumerable:!0,configurable:!0,writable:!0,value:r}):e[t]=r;let Gp=class extends e.Component{constructor(){super(...arguments),this.renderDropdown=t=>{return e.createElement(xs,(r=((e,t)=>{for(var r in t||(t={}))Jp.call(t,r)&&Zp(e,r,t[r]);if(Hp)for(var r of Hp(t))Yp.call(t,r)&&Zp(e,r,t[r]);return e})({Label:ta,Dropdown:oa},t),Wp(r,Vp({variant:"dark"}))));var r}}render(){const{callbacks:t}=this.props;if(!t||0===t.length)return null;const r=t.map((e=>e.operations.map((e=>e)))).reduce(((e,t)=>e.concat(t)),[]);if(!r.some((e=>e.codeSamples.length>0)))return null;const n=r.map(((e,t)=>({value:`${e.httpVerb.toUpperCase()}: ${e.name}`,idx:t})));return e.createElement("div",null,e.createElement(yi,null," Callback payload samples "),e.createElement(Xp,null,e.createElement(Tp,{items:r,renderDropdown:this.renderDropdown,label:"Callback",options:n},(t=>e.createElement(Bp,{key:"callbackPayloadSample",callback:t,renderDropdown:this.renderDropdown})))))}};Gp.contextType=de,Gp=((e,t,r,n)=>{for(var o,i=t,s=e.length-1;s>=0;s--)(o=e[s])&&(i=o(i)||i);return i})([la.observer],Gp);const Xp=re.div`
  background: ${({theme:e})=>e.codeBlock.backgroundColor};
  padding: ${e=>4*e.theme.spacing.unit}px;
`;Object.defineProperty,Object.getOwnPropertyDescriptor;let Kp=class extends e.Component{render(){const{operation:t}=this.props,r=t.codeSamples,n=r.length>0,o=1===r.length&&this.context.hideSingleRequestSampleTab;return n&&e.createElement("div",null,e.createElement(yi,null," ",L("requestSamples")," "),e.createElement(Wi,{defaultIndex:0},e.createElement(Ui.TabList,{hidden:o},r.map((t=>e.createElement(Ui.Tab,{key:t.lang+"_"+(t.label||"")},void 0!==t.label?t.label:t.lang)))),r.map((t=>e.createElement(Ui.TabPanel,{key:t.lang+"_"+(t.label||"")},go(t)?e.createElement("div",null,e.createElement(qp,{content:t.requestBodyContent})):e.createElement(Gs,{lang:t.lang,source:t.source}))))))||null}};Kp.contextType=de,Kp=((e,t,r,n)=>{for(var o,i=t,s=e.length-1;s>=0;s--)(o=e[s])&&(i=o(i)||i);return i})([la.observer],Kp);Object.defineProperty,Object.getOwnPropertyDescriptor;let eu=class extends e.Component{render(){const{operation:t}=this.props,r=t.responses.filter((e=>e.content&&e.content.hasSample));return r.length>0&&e.createElement("div",null,e.createElement(yi,null," ",L("responseSamples")," "),e.createElement(Wi,{defaultIndex:0},e.createElement(Ui.TabList,null,r.map((t=>e.createElement(Ui.Tab,{className:"tab-"+t.type,key:t.code},t.code)))),r.map((t=>e.createElement(Ui.TabPanel,{key:t.code},e.createElement("div",null,e.createElement(qp,{content:t.content})))))))||null}};eu=((e,t,r,n)=>{for(var o,i=t,s=e.length-1;s>=0;s--)(o=e[s])&&(i=o(i)||i);return i})([la.observer],eu);var tu=Object.defineProperty,ru=Object.defineProperties,nu=Object.getOwnPropertyDescriptors,ou=Object.getOwnPropertySymbols,iu=Object.prototype.hasOwnProperty,su=Object.prototype.propertyIsEnumerable,au=(e,t,r)=>t in e?tu(e,t,{enumerable:!0,configurable:!0,writable:!0,value:r}):e[t]=r;const lu=re.div`
  margin-bottom: ${({theme:e})=>6*e.spacing.unit}px;
`,cu=(0,la.observer)((({operation:t})=>{const{name:r,description:n,deprecated:o,externalDocs:i,isWebhook:s,httpVerb:a}=t,l=!(!n&&!i),{showWebhookVerb:c}=e.useContext(de);return e.createElement(de.Consumer,null,(p=>{return e.createElement(di,(u=((e,t)=>{for(var r in t||(t={}))iu.call(t,r)&&au(e,r,t[r]);if(ou)for(var r of ou(t))su.call(t,r)&&au(e,r,t[r]);return e})({},{[ti]:t.operationHash}),d={id:t.operationHash},ru(u,nu(d))),e.createElement(li,null,e.createElement(gi,null,e.createElement($i,{to:t.id}),r," ",o&&e.createElement(Ci,{type:"warning"}," Deprecated "),s&&e.createElement(Ci,{type:"primary"}," ","Webhook ",c&&a&&"| "+a.toUpperCase())),p.pathInMiddlePanel&&!s&&e.createElement(Zc,{operation:t,inverted:!0}),l&&e.createElement(lu,null,void 0!==n&&e.createElement(As,{source:n}),i&&e.createElement(Ea,{externalDocs:i})),e.createElement(ja,{extensions:t.extensions}),e.createElement(Sp,{securities:t.security}),e.createElement(ip,{parameters:t.parameters,body:t.requestBody}),e.createElement(kp,{responses:t.responses}),e.createElement(Pp,{callbacks:t.callbacks})),e.createElement(ui,null,!p.pathInMiddlePanel&&!s&&e.createElement(Zc,{operation:t}),e.createElement(Kp,{operation:t}),e.createElement(eu,{operation:t}),e.createElement(Gp,{callbacks:t.callbacks})));var u,d}))}));var pu=Object.defineProperty,uu=Object.getOwnPropertyDescriptor,du=Object.getOwnPropertySymbols,hu=Object.prototype.hasOwnProperty,mu=Object.prototype.propertyIsEnumerable,fu=(e,t,r)=>t in e?pu(e,t,{enumerable:!0,configurable:!0,writable:!0,value:r}):e[t]=r,gu=(e,t,r,n)=>{for(var o,i=n>1?void 0:n?uu(t,r):t,s=e.length-1;s>=0;s--)(o=e[s])&&(i=(n?o(t,r,i):o(i))||i);return n&&i&&pu(t,r,i),i};let yu=class extends e.Component{render(){const t=this.props.items;return 0===t.length?null:t.map((t=>e.createElement(bu,{key:t.id,item:t})))}};yu=gu([la.observer],yu);let bu=class extends e.Component{render(){const t=this.props.item;let r;const{type:n}=t;switch(n){case"group":r=null;break;case"tag":case"section":default:r=e.createElement(vu,((e,t)=>{for(var r in t||(t={}))hu.call(t,r)&&fu(e,r,t[r]);if(du)for(var r of du(t))mu.call(t,r)&&fu(e,r,t[r]);return e})({},this.props));break;case"operation":r=e.createElement(wu,{item:t})}return e.createElement(e.Fragment,null,r&&e.createElement(ci,{id:t.id,underlined:"operation"===t.type},r),t.items&&e.createElement(yu,{items:t.items}))}};bu=gu([la.observer],bu);const xu=t=>e.createElement(li,{compact:!0},t);let vu=class extends e.Component{render(){const{name:t,description:r,externalDocs:n,level:o}=this.props.item,i=2===o?gi:fi;return e.createElement(e.Fragment,null,e.createElement(di,null,e.createElement(li,{compact:!1},e.createElement(i,null,e.createElement($i,{to:this.props.item.id}),t))),e.createElement(Oc,{parentId:this.props.item.id,source:r||"",htmlWrap:xu}),n&&e.createElement(di,null,e.createElement(li,null,e.createElement(Ea,{externalDocs:n}))))}};vu=gu([la.observer],vu);let wu=class extends e.Component{render(){return e.createElement(cu,{operation:this.props.item})}};wu=gu([la.observer],wu);var ku=Object.defineProperty,Ou=(Object.getOwnPropertyDescriptor,Object.getOwnPropertySymbols),Eu=Object.prototype.hasOwnProperty,Su=Object.prototype.propertyIsEnumerable,$u=(e,t,r)=>t in e?ku(e,t,{enumerable:!0,configurable:!0,writable:!0,value:r}):e[t]=r;let Ru=class extends e.Component{render(){const{items:t,root:r,className:n}=this.props,o=null==this.props.expanded||this.props.expanded;return e.createElement(Cc,((e,t)=>{for(var r in t||(t={}))Eu.call(t,r)&&$u(e,r,t[r]);if(Ou)for(var r of Ou(t))Su.call(t,r)&&$u(e,r,t[r]);return e})({className:n,style:this.props.style,expanded:o},r?{role:"menu"}:{}),t.map(((t,r)=>e.createElement(Lu,{key:r,item:t,onActivate:this.props.onActivate}))))}};Ru=((e,t,r,n)=>{for(var o,i=t,s=e.length-1;s>=0;s--)(o=e[s])&&(i=o(i)||i);return i})([la.observer],Ru);var ju=Object.defineProperty,Cu=Object.defineProperties,Au=(Object.getOwnPropertyDescriptor,Object.getOwnPropertyDescriptors),Pu=Object.getOwnPropertySymbols,Iu=Object.prototype.hasOwnProperty,Tu=Object.prototype.propertyIsEnumerable,_u=(e,t,r)=>t in e?ju(e,t,{enumerable:!0,configurable:!0,writable:!0,value:r}):e[t]=r;let Lu=class extends e.Component{constructor(){super(...arguments),this.ref=e.createRef(),this.activate=e=>{this.props.onActivate(this.props.item),e.stopPropagation()}}componentDidMount(){this.scrollIntoViewIfActive()}componentDidUpdate(){this.scrollIntoViewIfActive()}scrollIntoViewIfActive(){this.props.item.active&&this.ref.current&&u(this.ref.current)}render(){const{item:t,withoutChildren:r}=this.props;return e.createElement(Ac,{onClick:this.activate,depth:t.depth,"data-item-id":t.id},"operation"===t.type?e.createElement(Du,(n=((e,t)=>{for(var r in t||(t={}))Iu.call(t,r)&&_u(e,r,t[r]);if(Pu)for(var r of Pu(t))Tu.call(t,r)&&_u(e,r,t[r]);return e})({},this.props),Cu(n,Au({item:t})))):e.createElement(Tc,{depth:t.depth,active:t.active,type:t.type,ref:this.ref},e.createElement(Lc,{title:t.sidebarLabel},t.sidebarLabel,this.props.children),t.depth>0&&t.items.length>0&&e.createElement(ji,{float:"right",direction:t.expanded?"down":"right"})||null),!r&&t.items&&t.items.length>0&&e.createElement(Ru,{expanded:t.expanded,items:t.items,onActivate:this.props.onActivate}));var n}};Lu=((e,t,r,n)=>{for(var o,i=t,s=e.length-1;s>=0;s--)(o=e[s])&&(i=o(i)||i);return i})([la.observer],Lu);const Du=(0,la.observer)((t=>{const{item:r}=t,n=e.createRef(),{showWebhookVerb:o}=e.useContext(de);return e.useEffect((()=>{t.item.active&&n.current&&u(n.current)}),[t.item.active,n]),e.createElement(Tc,{depth:r.depth,active:r.active,deprecated:r.deprecated,ref:n},r.isWebhook?e.createElement(Rc,{type:"hook"},o?r.httpVerb:L("webhook")):e.createElement(Rc,{type:r.httpVerb},xt(r.httpVerb)),e.createElement(Lc,{width:"calc(100% - 38px)"},r.sidebarLabel,t.children))}));function zu(){const[t,r]=(0,e.useState)(!1);return(0,e.useEffect)((()=>{r(!0)}),[]),t?e.createElement("img",{alt:"redocly logo",onError:()=>r(!1),src:"https://cdn.redoc.ly/redoc/logo-mini.svg"}):null}Object.defineProperty,Object.getOwnPropertyDescriptor;let Mu=class extends e.Component{constructor(){super(...arguments),this.activate=e=>{if(e&&e.active&&this.context.menuToggle)return e.expanded?e.collapse():e.expand();this.props.menu.activateAndScroll(e,!0),setTimeout((()=>{this._updateScroll&&this._updateScroll()}))},this.saveScrollUpdate=e=>{this._updateScroll=e}}render(){const t=this.props.menu;return e.createElement(ls,{updateFn:this.saveScrollUpdate,className:this.props.className,options:{wheelPropagation:!1}},e.createElement(Ru,{items:t.items,onActivate:this.activate,root:!0}),e.createElement(Dc,null,e.createElement("a",{target:"_blank",rel:"noopener noreferrer",href:"https://redocly.com/redoc/"},e.createElement(zu,null),"API docs by Redocly")))}};Mu.contextType=de,Mu=((e,t,r,n)=>{for(var o,i=t,s=e.length-1;s>=0;s--)(o=e[s])&&(i=o(i)||i);return i})([la.observer],Mu);const Nu=({backNavigationPath:t,siteTitle:r})=>{const n=null!=t?t:"https://mongodb.com/docs/",o=`Back to ${null!=r?r:""} Docs`;return e.createElement(e.Fragment,null,e.createElement(Cc,{expanded:!0},e.createElement(Ac,{depth:1},e.createElement(Pc,{href:n},e.createElement(Tc,{depth:1,active:!1,isBackButton:!0},e.createElement(Lc,null,"← ",o))))),e.createElement(_c,null))},Fu=({open:t})=>{const r=t?8:-4;return e.createElement(Bu,null,e.createElement(qu,{size:15,style:{transform:`translate(2px, ${r}px) rotate(180deg)`,transition:"transform 0.2s ease"}}),e.createElement(qu,{size:15,style:{transform:`translate(2px, ${0-r}px)`,transition:"transform 0.2s ease"}}))},qu=({size:t=10,className:r="",style:n})=>e.createElement("svg",{className:r,style:n||{},viewBox:"0 0 926.23699 573.74994",version:"1.1",x:"0px",y:"0px",width:t,height:t},e.createElement("g",{transform:"translate(904.92214,-879.1482)"},e.createElement("path",{d:"\n          m -673.67664,1221.6502 -231.2455,-231.24803 55.6165,\n          -55.627 c 30.5891,-30.59485 56.1806,-55.627 56.8701,-55.627 0.6894,\n          0 79.8637,78.60862 175.9427,174.68583 l 174.6892,174.6858 174.6892,\n          -174.6858 c 96.079,-96.07721 175.253196,-174.68583 175.942696,\n          -174.68583 0.6895,0 26.281,25.03215 56.8701,\n          55.627 l 55.6165,55.627 -231.245496,231.24803 c -127.185,127.1864\n          -231.5279,231.248 -231.873,231.248 -0.3451,0 -104.688,\n          -104.0616 -231.873,-231.248 z\n        ",fill:"currentColor"}))),Bu=re.div`
  user-select: none;
  width: 20px;
  height: 20px;
  align-self: center;
  ...
  flex-direction: column;
  color: ${e=>e.theme.colors.primary.main};
`;Object.defineProperty,Object.getOwnPropertyDescriptor;let Qu;l&&(Qu=r(322));const Uu=Qu&&Qu(),Wu=re.div`
...
`;let Hu=class extends e.Component{constructor(){super(...arguments),this.state={offsetTop:"0px"},this.toggleNavMenu=()=>{this.props.menu.toggleSidebar()}}componentDidMount(){Uu&&Uu.add(this.stickyElement),this.setState({offsetTop:this.getScrollYOffset(this.context)})}componentWillUnmount(){Uu&&Uu.remove(this.stickyElement)}getScrollYOffset(e){let t;return t=void 0!==this.props.scrollYOffset?H.normalizeScrollYOffset(this.props.scrollYOffset)():e.scrollYOffset(),t+"px"}render(){const t=this.props.menu.sideBarOpened,r=this.state.offsetTop;return e.createElement(e.Fragment,null,e.createElement(Wu,{open:t,className:this.props.className,style:{top:r,height:`calc(100vh - ${r})`},ref:e=>{this.stickyElement=e}},this.props.children),!this.context.hideFab&&e.createElement(Vu,{onClick:this.toggleNavMenu},e.createElement(Fu,{open:t})))}};Hu.contextType=de,Hu=((e,t,r,n)=>{for(var o,i=t,s=e.length-1;s>=0;s--)(o=e[s])&&(i=o(i)||i);return i})([la.observer],Hu);const Ju=re.header`
  position: relative;
  width: 100%;
  z-index: 99;
`,Yu=re.div`
...
`,nd=re.i`
  ...
  font-style: normal;
  color: '#666';
`;var od=Object.defineProperty,id=Object.getOwnPropertyDescriptor;class sd extends e.PureComponent{constructor(e){super(e),this.activeItemRef=null,this.clear=()=>{this.setState({results:[],noResults:!1,term:"",activeItemIdx:-1}),this.props.marker.unmark()},this.handleKeyDown=e=>{if(27===e.keyCode&&this.clear(),40===e.keyCode&&(this.setState({activeItemIdx:Math.min(this.state.activeItemIdx+1,this.state.results.length-1)}),e.preventDefault()),38===e.keyCode&&(this.setState({activeItemIdx:Math.max(0,this.state.activeItemIdx-1)}),e.preventDefault()),13===e.keyCode){const e=this.state.results[this.state.activeItemIdx];if(e){const t=this.props.getItemById(e.meta);t&&this.props.onActivate(t)}}},this.search=e=>{const{minCharacterLengthToInitSearch:t}=this.context,r=e.target.value;r.length<t?this.clearResults(r):this.setState({term:r},(()=>this.searchCallback(this.state.term)))},this.state={results:[],noResults:!1,term:"",activeItemIdx:-1}}clearResults(e){this.setState({results:[],noResults:!1,term:e}),this.props.marker.unmark()}setResults(e,t){this.setState({results:e,noResults:0===e.length}),this.props.marker.mark(t)}searchCallback(e){this.props.search.search(e).then((t=>{this.setResults(t,e)}))}render(){const{activeItemIdx:t}=this.state,r=this.state.results.filter((e=>this.props.getItemById(e.meta))).map((e=>({item:this.props.getItemById(e.meta),score:e.score}))).sort(((e,t)=>t.score-e.score));return e.createElement(Ku,{role:"search","data-role":"redoc-search"},this.state.term&&e.createElement(nd,{onClick:this.clear},"×"),e.createElement(td,null),e.createElement(ed,{value:this.state.term,onKeyDown:this.handleKeyDown,placeholder:"Search...","aria-label":"Search",type:"text",onChange:this.search}),r.length>0&&e.createElement(ls,{options:{wheelPropagation:!1}},e.createElement(rd,{"data-role":"search:results"},r.map(((r,n)=>e.createElement(Lu,{item:Object.create(r.item,{active:{value:n===t}}),onActivate:this.props.onActivate,withoutChildren:!0,key:r.item.id,"data-role":"search:result"}))))),this.state.term&&this.state.noResults?e.createElement(rd,{"data-role":"search:results"},L("noResultsFound")):null)}}sd.contextType=de,((e,t,r,n)=>{for(var o,i=id(t,r),s=e.length-1;s>=0;s--)(o=e[s])&&(i=o(t,r,i)||i);i&&od(t,r,i)})([we.bind,(0,we.debounce)(400)],sd.prototype,"searchCallback");class ad extends e.Component{componentDidMount(){this.props.store.onDidMount()}componentWillUnmount(){this.props.store.dispose()}render(){var t,r;const{store:{spec:n,menu:o,options:i,search:s,marker:a}}=this.props,l=this.props.store;return e.createElement(ee,{theme:i.theme},e.createElement(vi,{value:l},e.createElement(he,{value:i},e.createElement(Ju,null,e.createElement(ue.UnifiedNav,{position:"relative",property:{name:"DOCS",searchParams:[]}})),e.createElement(Zu,{className:"redoc-wrap"},e.createElement(Hu,{menu:o,className:"menu-content"},e.createElement(gc,{info:n.info}),e.createElement(Nu,{backNavigationPath:null==(t=i.customOptions)?void 0:t.backNavigationPath,siteTitle:null==(r=i.customOptions)?void 0:r.siteTitle}),e.createElement(Yu,null,l.spec.info.title),!i.disableSearch&&e.createElement(sd,{search:s,marker:a,getItemById:o.getItemById,onActivate:o.activateAndScroll})||null,e.createElement(Mu,{menu:o})),e.createElement(Gu,{className:"api-content"},e.createElement(dc,{store:l}),e.createElement(yu,{items:o.items})),e.createElement(Xu,null)),e.createElement(ue.UnifiedFooter,{hideLocale:!0}))))}}ad.propTypes={store:pe.instanceOf(ic).isRequired};const ld=function(t){const{spec:n,specUrl:o,options:i={},onLoaded:s}=t,a=W(i.hideLoading,!1),l=new H(i);if(void 0!==l.nonce)try{r.nc=l.nonce}catch(e){}return e.createElement(ie,null,e.createElement(ki,{spec:n,specUrl:o,options:i,onLoaded:s},(({loading:t,store:r})=>t?a?null:e.createElement(ce,{color:l.theme.colors.primary.main}):e.createElement(ad,{store:r}))))}}(),n}()}));
