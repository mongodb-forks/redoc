...
export declare const StyledResponseTitle: import("styled-components").StyledComponent<import("react").NamedExoticComponent<import("./ResponseTitle").ResponseTitleProps>, import("../../theme").ResolvedThemeInterface, {}, never>;
